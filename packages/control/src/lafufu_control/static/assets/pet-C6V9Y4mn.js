...
`)}const rp={[Xo]:"Linear",[qo]:"Reinhard",[Yo]:"Cineon",[ua]:"ACESFilmic",[Ko]:"AgX",[Zo]:"Neutral",[$o]:"Custom"};function sp(i,e){const t=rp[e];return t===void 0?(Ie("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const fr=new O;function ap(){Xe.getLuminanceCoefficients(fr);const i=fr.x.toFixed(4),e=fr.y.toFixed(4),t=fr.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`].filter(Ii).join(`
`)),a=la(a),a=Fo(a,t),a=Oo(a,t),o=la(o),o=Fo(o,t),o=Oo(o,t),a=Bo(a),o=Bo(o),t.isRawShaderMaterial!==!0&&(S=`#version 300 es
...
}`,Vp=[new O(1,0,0),new O(-1,0,0),new O(0,1,0),new O(0,-1,0),new O(0,0,1),new O(0,0,-1)],Hp=[new O(0,-1,0),new O(0,-1,0),new O(0,0,1),new O(0,0,-1),new O(0,-1,0),new O(0,-1,0)],ko=new ht,Pi=new O,ms=new O;function kp(i,e,t){let n=new Ea;const r=new je,s=new je,a=new ut,o=new Jc,c=new Qc,l={},f=t.maxTextureSize,m={[In]:Ct,[Ct]:In,[pn]:pn},u=new sn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new je},radius:{value:4}},vertexShader:zp,fragmentShader:Gp}),_=u.clone();_.defines.HORIZONTAL_PASS=1;const v=new Bt;v.setAttribute("position",new nn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const y=new lt(v,u),p=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=mr;let h=this.type;this.render=function(b,D,g){if(p.enabled===!1||p.autoUpdate===!1&&p.needsUpdate===!1||b.length===0)return;this.type===Hl&&(Ie("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=mr);const A=i.getRenderTarget(),L=i.getActiveCubeFace(),w=i.getActiveMipmapLevel(),F=i.state;F.setBlending(gn),F.buffers.depth.getReversed()===!0?F.buffers.color.setClear(0,0,0,0):F.buffers.color.setClear(1,1,1,1),F.buffers.depth.setTest(!0),F.setScissorTest(!1);const W=h!==this.type;W&&D.traverse(function(Y){Y.material&&(Array.isArray(Y.material)?Y.material.forEach(N=>N.needsUpdate=!0):Y.material.needsUpdate=!0)});for(let Y=0,N=b.length;Y<N;Y++){const B=b[Y],V=B.shadow;if(V===void 0){Ie("WebGLShadowMap:",B,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;r.copy(V.mapSize);const J=V.getFrameExtents();r.multiply(J),s.copy(V.mapSize),(r.x>f||r.y>f)&&(r.x>f&&(s.x=Math.floor(f/J.x),r.x=s.x*J.x,V.mapSize.x=s.x),r.y>f&&(s.y=Math.floor(f/J.y),r.y=s.y*J.y,V.mapSize.y=s.y));const ne=i.state.buffers.depth.getReversed();if(V.camera._reversedDepth=ne,V.map===null||W===!0){if(V.map!==null&&(V.map.depthTexture!==null&&(V.map.depthTexture.dispose(),V.map.depthTexture=null),V.map.dispose()),this.type===Li){if(B.isPointLight){Ie("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}V.map=new tn(r.x,r.y,{format:Kn,type:vn,minFilter:At,magFilter:At,generateMipmaps:!1}),V.map.texture.name=B.name+".shadowMap",V.map.depthTexture=new vi(r.x,r.y,Jt),V.map.depthTexture.name=B.name+".shadowMapDepth",V.map.depthTexture.format=Mn,V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=Et,V.map.depthTexture.magFilter=Et}else B.isPointLight?(V.map=new xl(r.x),V.map.depthTexture=new qc(r.x,rn)):(V.map=new tn(r.x,r.y),V.map.depthTexture=new vi(r.x,r.y,rn)),V.map.depthTexture.name=B.name+".shadowMap",V.map.depthTexture.format=Mn,this.type===mr?(V.map.depthTexture.compareFunction=ne?xa:ga,V.map.depthTexture.minFilter=At,V.map.depthTexture.magFilter=At):(V.map.depthTexture.compareFunction=null,V.map.depthTexture.minFilter=Et,V.map.depthTexture.magFilter=Et);V.camera.updateProjectionMatrix()}const oe=V.map.isWebGLCubeRenderTarget?6:1;for(let ve=0;ve<oe;ve++){if(V.map.isWebGLCubeRenderTarget)i.setRenderTarget(V.map,ve),i.clear();else{ve===0&&(i.setRenderTarget(V.map),i.clear());const Ee=V.getViewport(ve);a.set(s.x*Ee.x,s.y*Ee.y,s.x*Ee.z,s.y*Ee.w),F.viewport(a)}if(B.isPointLight){const Ee=V.camera,ke=V.matrix,Ve=B.distance||Ee.far;Ve!==Ee.far&&(Ee.far=Ve,Ee.updateProjectionMatrix()),Pi.setFromMatrixPosition(B.matrixWorld),Ee.position.copy(Pi),ms.copy(Ee.position),ms.add(Vp[ve]),Ee.up.copy(Hp[ve]),Ee.lookAt(ms),Ee.updateMatrixWorld(),ke.makeTranslation(-Pi.x,-Pi.y,-Pi.z),ko.multiplyMatrices(Ee.projectionMatrix,Ee.matrixWorldInverse),V._frustum.setFromProjectionMatrix(ko,Ee.coordinateSystem,Ee.reversedDepth)}else V.updateMatrices(B);n=V.getFrustum(),E(D,g,V.camera,B,this.type)}V.isPointLightShadow!==!0&&this.type===Li&&S(V,g),V.needsUpdate=!1}h=this.type,p.needsUpdate=!1,i.setRenderTarget(A,L,w)};function S(b,D){const g=e.update(y);u.defines.VSM_SAMPLES!==b.blurSamples&&(u.defines.VSM_SAMPLES=b.blurSamples,_.defines.VSM_SAMPLES=b.blurSamples,u.needsUpdate=!0,_.needsUpdate=!0),b.mapPass===null&&(b.mapPass=new tn(r.x,r.y,{format:Kn,type:vn})),u.uniforms.shadow_pass.value=b.map.depthTexture,u.uniforms.resolution.value=b.mapSize,u.uniforms.radius.value=b.radius,i.setRenderTarget(b.mapPass),i.clear(),i.renderBufferDirect(D,null,g,u,y,null),_.uniforms.shadow_pass.value=b.mapPass.texture,_.uniforms.resolution.value=b.mapSize,_.uniforms.radius.value=b.radius,i.setRenderTarget(b.map),i.clear(),i.renderBufferDirect(D,null,g,_,y,null)}function T(b,D,g,A){let L=null;const w=g.isPointLight===!0?b.customDistanceMaterial:b.customDepthMaterial;if(w!==void 0)L=w;else if(L=g.isPointLight===!0?c:o,i.localClippingEnabled&&D.clipShadows===!0&&Array.isArray(D.clippingPlanes)&&D.clippingPlanes.length!==0||D.displacementMap&&D.displacementScale!==0||D.alphaMap&&D.alphaTest>0||D.map&&D.alphaTest>0||D.alphaToCoverage===!0){const F=L.uuid,W=D.uuid;let Y=l[F];Y===void 0&&(Y={},l[F]=Y);let N=Y[W];N===void 0&&(N=L.clone(),Y[W]=N,D.addEventListener("dispose",R)),L=N}if(L.visible=D.visible,L.wireframe=D.wireframe,A===Li?L.side=D.shadowSide!==null?D.shadowSide:D.side:L.side=D.shadowSide!==null?D.shadowSide:m[D.side],L.alphaMap=D.alphaMap,L.alphaTest=D.alphaToCoverage===!0?.5:D.alphaTest,L.map=D.map,L.clipShadows=D.clipShadows,L.clippingPlanes=D.clippingPlanes,L.clipIntersection=D.clipIntersection,L.displacementMap=D.displacementMap,L.displacementScale=D.displacementScale,L.displacementBias=D.displacementBias,L.wireframeLinewidth=D.wireframeLinewidth,L.linewidth=D.linewidth,g.isPointLight===!0&&L.isMeshDistanceMaterial===!0){const F=i.properties.get(L);F.light=g}return L}function E(b,D,g,A,L){if(b.visible===!1)return;if(b.layers.test(D.layers)&&(b.isMesh||b.isLine||b.isPoints)&&(b.castShadow||b.receiveShadow&&L===Li)&&(!b.frustumCulled||n.intersectsObject(b))){b.modelViewMatrix.multiplyMatrices(g.matrixWorldInverse,b.matrixWorld);const W=e.update(b),Y=b.material;if(Array.isArray(Y)){const N=W.groups;for(let B=0,V=N.length;B<V;B++){const J=N[B],ne=Y[J.materialIndex];if(ne&&ne.visible){const oe=T(b,ne,A,L);b.onBeforeShadow(i,b,D,g,W,oe,J),i.renderBufferDirect(g,null,W,oe,b,J),b.onAfterShadow(i,b,D,g,W,oe,J)}}}else if(Y.visible){const N=T(b,Y,A,L);b.onBeforeShadow(i,b,D,g,W,N,null),i.renderBufferDirect(g,null,W,N,b,null),b.onAfterShadow(i,b,D,g,W,N,null)}}const F=b.children;for(let W=0,Y=F.length;W<Y;W++)E(F[W],D,g,A,L)}function R(b){b.target.removeEventListener("dispose",R);for(const g in l){const A=l[g],L=b.target.uuid;L in A&&(A[L].dispose(),delete A[L])}}}function Wp(i,e){function t(){let P=!1;const ae=new ut;let $=null;const xe=new ut(0,0,0,0);return{setMask:function(ce){$!==ce&&!P&&(i.colorMask(ce,ce,ce,ce),$=ce)},setLocked:function(ce){P=ce},setClear:function(ce,te,Ae,Be,ft){ft===!0&&(ce*=Be,te*=Be,Ae*=Be),ae.set(ce,te,Ae,Be),xe.equals(ae)===!1&&(i.clearColor(ce,te,Ae,Be),xe.copy(ae))},reset:function(){P=!1,$=null,xe.set(-1,0,0,0)}}}function n(){let P=!1,ae=!1,$=null,xe=null,ce=null;return{setReversed:function(te){if(ae!==te){const Ae=e.get("EXT_clip_control");te?Ae.clipControlEXT(Ae.LOWER_LEFT_EXT,Ae.ZERO_TO_ONE_EXT):Ae.clipControlEXT(Ae.LOWER_LEFT_EXT,Ae.NEGATIVE_ONE_TO_ONE_EXT),ae=te;const Be=ce;ce=null,this.setClear(Be)}},getReversed:function(){return ae},setTest:function(te){te?ie(i.DEPTH_TEST):ye(i.DEPTH_TEST)},setMask:function(te){$!==te&&!P&&(i.depthMask(te),$=te)},setFunc:function(te){if(ae&&(te=Sc[te]),xe!==te){switch(te){case xs:i.depthFunc(i.NEVER);break;case vs:i.depthFunc(i.ALWAYS);break;case Ms:i.depthFunc(i.LESS);break;case gi:i.depthFunc(i.LEQUAL);break;case Ss:i.depthFunc(i.EQUAL);break;case Es:i.depthFunc(i.GEQUAL);break;case ys:i.depthFunc(i.GREATER);break;case bs:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}xe=te}},setLocked:function(te){P=te},setClear:function(te){ce!==te&&(ce=te,ae&&(te=1-te),i.clearDepth(te))},reset:function(){P=!1,$=null,xe=null,ce=null,ae=!1}}}function r(){let P=!1,ae=null,$=null,xe=null,ce=null,te=null,Ae=null,Be=null,ft=null;return{setTest:function(tt){P||(tt?ie(i.STENCIL_TEST):ye(i.STENCIL_TEST))},setMask:function(tt){ae!==tt&&!P&&(i.stencilMask(tt),ae=tt)},setFunc:function(tt,an,Yt){($!==tt||xe!==an||ce!==Yt)&&(i.stencilFunc(tt,an,Yt),$=tt,xe=an,ce=Yt)},setOp:function(tt,an,Yt){(te!==tt||Ae!==an||Be!==Yt)&&(i.stencilOp(tt,an,Yt),te=tt,Ae=an,Be=Yt)},setLocked:function(tt){P=tt},setClear:function(tt){ft!==tt&&(i.clearStencil(tt),ft=tt)},reset:function(){P=!1,ae=null,$=null,xe=null,ce=null,te=null,Ae=null,Be=null,ft=null}}}const s=new t,a=new n,o=new r,c=new WeakMap,l=new WeakMap;let f={},m={},u={},_=new WeakMap,v=[],y=null,p=!1,h=null,S=null,T=null,E=null,R=null,b=null,D=null,g=new Ze(0,0,0),A=0,L=!1,w=null,F=null,W=null,Y=null,N=null;const B=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let V=!1,J=0;const ne=i.getParameter(i.VERSION);ne.indexOf("WebGL")!==-1?(J=parseFloat(/^WebGL (\d)/.exec(ne)[1]),V=J>=1):ne.indexOf("OpenGL ES")!==-1&&(J=parseFloat(/^OpenGL ES (\d)/.exec(ne)[1]),V=J>=2);let oe=null,ve={};const Ee=i.getParameter(i.SCISSOR_BOX),ke=i.getParameter(i.VIEWPORT),Ve=new ut().fromArray(Ee),Le=new ut().fromArray(ke);function K(P,ae,$,xe){const ce=new Uint8Array(4),te=i.createTexture();i.bindTexture(P,te),i.texParameteri(P,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(P,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Ae=0;Ae<$;Ae++)P===i.TEXTURE_3D||P===i.TEXTURE_2D_ARRAY?i.texImage3D(ae,0,i.RGBA,1,1,xe,0,i.RGBA,i.UNSIGNED_BYTE,ce):i.texImage2D(ae+Ae,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,ce);return te}const le={};le[i.TEXTURE_2D]=K(i.TEXTURE_2D,i.TEXTURE_2D,1),le[i.TEXTURE_CUBE_MAP]=K(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),le[i.TEXTURE_2D_ARRAY]=K(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),le[i.TEXTURE_3D]=K(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),ie(i.DEPTH_TEST),a.setFunc(gi),Fe(!1),Qe(Ha),ie(i.CULL_FACE),fe(gn);function ie(P){f[P]!==!0&&(i.enable(P),f[P]=!0)}function ye(P){f[P]!==!1&&(i.disable(P),f[P]=!1)}function De(P,ae){return u[P]!==ae?(i.bindFramebuffer(P,ae),u[P]=ae,P===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=ae),P===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=ae),!0):!1}function we(P,ae){let $=v,xe=!1;if(P){$=_.get(ae),$===void 0&&($=[],_.set(ae,$));const ce=P.textures;if($.length!==ce.length||$[0]!==i.COLOR_ATTACHMENT0){for(let te=0,Ae=ce.length;te<Ae;te++)$[te]=i.COLOR_ATTACHMENT0+te;$.length=ce.length,xe=!0}}else $[0]!==i.BACK&&($[0]=i.BACK,xe=!0);xe&&i.drawBuffers($)}function it(P){return y!==P?(i.useProgram(P),y=P,!0):!1}const j={[Wn]:i.FUNC_ADD,[Wl]:i.FUNC_SUBTRACT,[Xl]:i.FUNC_REVERSE_SUBTRACT};j[ql]=i.MIN,j[Yl]=i.MAX;const ge={[$l]:i.ZERO,[Kl]:i.ONE,[Zl]:i.SRC_COLOR,[_s]:i.SRC_ALPHA,[nc]:i.SRC_ALPHA_SATURATE,[ec]:i.DST_COLOR,[Jl]:i.DST_ALPHA,[jl]:i.ONE_MINUS_SRC_COLOR,[gs]:i.ONE_MINUS_SRC_ALPHA,[tc]:i.ONE_MINUS_DST_COLOR,[Ql]:i.ONE_MINUS_DST_ALPHA,[ic]:i.CONSTANT_COLOR,[rc]:i.ONE_MINUS_CONSTANT_COLOR,[sc]:i.CONSTANT_ALPHA,[ac]:i.ONE_MINUS_CONSTANT_ALPHA};function fe(P,ae,$,xe,ce,te,Ae,Be,ft,tt){if(P===gn){p===!0&&(ye(i.BLEND),p=!1);return}if(p===!1&&(ie(i.BLEND),p=!0),P!==kl){if(P!==h||tt!==L){if((S!==Wn||R!==Wn)&&(i.blendEquation(i.FUNC_ADD),S=Wn,R=Wn),tt)switch(P){case mi:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ka:i.blendFunc(i.ONE,i.ONE);break;case Wa:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case Xa:i.blendFuncSeparate(i.DST_COLOR,i.ONE_MINUS_SRC_ALPHA,i.ZERO,i.ONE);break;default:$e("WebGLState: Invalid blending: ",P);break}else switch(P){case mi:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case ka:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE,i.ONE,i.ONE);break;case Wa:$e("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Xa:$e("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:$e("WebGLState: Invalid blending: ",P);break}T=null,E=null,b=null,D=null,g.set(0,0,0),A=0,h=P,L=tt}return}ce=ce||ae,te=te||$,Ae=Ae||xe,(ae!==S||ce!==R)&&(i.blendEquationSeparate(j[ae],j[ce]),S=ae,R=ce),($!==T||xe!==E||te!==b||Ae!==D)&&(i.blendFuncSeparate(ge[$],ge[xe],ge[te],ge[Ae]),T=$,E=xe,b=te,D=Ae),(Be.equals(g)===!1||ft!==A)&&(i.blendColor(Be.r,Be.g,Be.b,ft),g.copy(Be),A=ft),h=P,L=!1}function Te(P,ae){P.side===pn?ye(i.CULL_FACE):ie(i.CULL_FACE);let $=P.side===Ct;ae&&($=!$),Fe($),P.blending===mi&&P.transparent===!1?fe(gn):fe(P.blending,P.blendEquation,P.blendSrc,P.blendDst,P.blendEquationAlpha,P.blendSrcAlpha,P.blendDstAlpha,P.blendColor,P.blendAlpha,P.premultipliedAlpha),a.setFunc(P.depthFunc),a.setTest(P.depthTest),a.setMask(P.depthWrite),s.setMask(P.colorWrite);const xe=P.stencilWrite;o.setTest(xe),xe&&(o.setMask(P.stencilWriteMask),o.setFunc(P.stencilFunc,P.stencilRef,P.stencilFuncMask),o.setOp(P.stencilFail,P.stencilZFail,P.stencilZPass)),C(P.polygonOffset,P.polygonOffsetFactor,P.polygonOffsetUnits),P.alphaToCoverage===!0?ie(i.SAMPLE_ALPHA_TO_COVERAGE):ye(i.SAMPLE_ALPHA_TO_COVERAGE)}function Fe(P){w!==P&&(P?i.frontFace(i.CW):i.frontFace(i.CCW),w=P)}function Qe(P){P!==Gl?(ie(i.CULL_FACE),P!==F&&(P===Ha?i.cullFace(i.BACK):P===Vl?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):ye(i.CULL_FACE),F=P}function vt(P){P!==W&&(V&&i.lineWidth(P),W=P)}function C(P,ae,$){P?(ie(i.POLYGON_OFFSET_FILL),(Y!==ae||N!==$)&&(Y=ae,N=$,a.getReversed()&&(ae=-ae),i.polygonOffset(ae,$))):ye(i.POLYGON_OFFSET_FILL)}function rt(P){P?ie(i.SCISSOR_TEST):ye(i.SCISSOR_TEST)}function Oe(P){P===void 0&&(P=i.TEXTURE0+B-1),oe!==P&&(i.activeTexture(P),oe=P)}function Ye(P,ae,$){$===void 0&&(oe===null?$=i.TEXTURE0+B-1:$=oe);let xe=ve[$];xe===void 0&&(xe={type:void 0,texture:void 0},ve[$]=xe),(xe.type!==P||xe.texture!==ae)&&(oe!==$&&(i.activeTexture($),oe=$),i.bindTexture(P,ae||le[P]),xe.type=P,xe.texture=ae)}function ue(){const P=ve[oe];P!==void 0&&P.type!==void 0&&(i.bindTexture(P.type,null),P.type=void 0,P.texture=void 0)}function Pe(){try{i.compressedTexImage2D(...arguments)}catch(P){$e("WebGLState:",P)}}function M(){try{i.compressedTexImage3D(...arguments)}catch(P){$e("WebGLState:",P)}}function d(){try{i.texSubImage2D(...arguments)}catch(P){$e("WebGLState:",P)}}function I(){try{i.texSubImage3D(...arguments)}catch(P){$e("WebGLState:",P)}}function q(){try{i.compressedTexSubImage2D(...arguments)}catch(P){$e("WebGLState:",P)}}function Z(){try{i.compressedTexSubImage3D(...arguments)}catch(P){$e("WebGLState:",P)}}function ee(){try{i.texStorage2D(...arguments)}catch(P){$e("WebGLState:",P)}}function Q(){try{i.texStorage3D(...arguments)}catch(P){$e("WebGLState:",P)}}function k(){try{i.texImage2D(...arguments)}catch(P){$e("WebGLState:",P)}}function X(){try{i.texImage3D(...arguments)}catch(P){$e("WebGLState:",P)}}function he(P){return m[P]!==void 0?m[P]:i.getParameter(P)}function _e(P,ae){m[P]!==ae&&(i.pixelStorei(P,ae),m[P]=ae)}function re(P){Ve.equals(P)===!1&&(i.scissor(P.x,P.y,P.z,P.w),Ve.copy(P))}function se(P){Le.equals(P)===!1&&(i.viewport(P.x,P.y,P.z,P.w),Le.copy(P))}function Ue(P,ae){let $=l.get(ae);$===void 0&&($=new WeakMap,l.set(ae,$));let xe=$.get(P);xe===void 0&&(xe=i.getUniformBlockIndex(ae,P.name),$.set(P,xe))}function Ge(P,ae){const xe=l.get(ae).get(P);c.get(ae)!==xe&&(i.uniformBlockBinding(ae,xe,P.__bindingPointIndex),c.set(ae,xe))}function Je(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),a.setReversed(!1),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),i.pixelStorei(i.PACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_ALIGNMENT,4),i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,!1),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,i.BROWSER_DEFAULT_WEBGL),i.pixelStorei(i.PACK_ROW_LENGTH,0),i.pixelStorei(i.PACK_SKIP_PIXELS,0),i.pixelStorei(i.PACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_ROW_LENGTH,0),i.pixelStorei(i.UNPACK_IMAGE_HEIGHT,0),i.pixelStorei(i.UNPACK_SKIP_PIXELS,0),i.pixelStorei(i.UNPACK_SKIP_ROWS,0),i.pixelStorei(i.UNPACK_SKIP_IMAGES,0),f={},m={},oe=null,ve={},u={},_=new WeakMap,v=[],y=null,p=!1,h=null,S=null,T=null,E=null,R=null,b=null,D=null,g=new Ze(0,0,0),A=0,L=!1,w=null,F=null,W=null,Y=null,N=null,Ve.set(0,0,i.canvas.width,i.canvas.height),Le.set(0,0,i.canvas.width,i.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:ie,disable:ye,bindFramebuffer:De,drawBuffers:we,useProgram:it,setBlending:fe,setMaterial:Te,setFlipSided:Fe,setCullFace:Qe,setLineWidth:vt,setPolygonOffset:C,setScissorTest:rt,activeTexture:Oe,bindTexture:Ye,unbindTexture:ue,compressedTexImage2D:Pe,compressedTexImage3D:M,texImage2D:k,texImage3D:X,pixelStorei:_e,getParameter:he,updateUBOMapping:Ue,uniformBlockBinding:Ge,texStorage2D:ee,texStorage3D:Q,texSubImage2D:d,texSubImage3D:I,compressedTexSubImage2D:q,compressedTexSubImage3D:Z,scissor:re,viewport:se,reset:Je}}function Xp(i,e,t,n,r,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new je,f=new WeakMap,m=new Set;let u;const _=new WeakMap;let v=!1;try{v=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function y(M,d){return v?new OffscreenCanvas(M,d):Tr("canvas")}function p(M,d,I){let q=1;const Z=Pe(M);if((Z.width>I||Z.height>I)&&(q=I/Math.max(Z.width,Z.height)),q<1)if(typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&M instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&M instanceof ImageBitmap||typeof VideoFrame<"u"&&M instanceof VideoFrame){const ee=Math.floor(q*Z.width),Q=Math.floor(q*Z.height);u===void 0&&(u=y(ee,Q));const k=d?y(ee,Q):u;return k.width=ee,k.height=Q,k.getContext("2d").drawImage(M,0,0,ee,Q),Ie("WebGLRenderer: Texture has been resized from ("+Z.width+"x"+Z.height+") to ("+ee+"x"+Q+")."),k}else return"data"in M&&Ie("WebGLRenderer: Image in DataTexture is too big ("+Z.width+"x"+Z.height+")."),M;return M}function h(M){return M.generateMipmaps}function S(M){i.generateMipmap(M)}function T(M){return M.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:M.isWebGL3DRenderTarget?i.TEXTURE_3D:M.isWebGLArrayRenderTarget||M.isCompressedArrayTexture?i.TEXTURE_2D_ARRAY:i.TEXTURE_2D}function E(M,d,I,q,Z,ee=!1){if(M!==null){if(i[M]!==void 0)return i[M];Ie("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+M+"'")}let Q;q&&(Q=e.get("EXT_texture_norm16"),Q||Ie("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let k=d;if(d===i.RED&&(I===i.FLOAT&&(k=i.R32F),I===i.HALF_FLOAT&&(k=i.R16F),I===i.UNSIGNED_BYTE&&(k=i.R8),I===i.UNSIGNED_SHORT&&Q&&(k=Q.R16_EXT),I===i.SHORT&&Q&&(k=Q.R16_SNORM_EXT)),d===i.RED_INTEGER&&(I===i.UNSIGNED_BYTE&&(k=i.R8UI),I===i.UNSIGNED_SHORT&&(k=i.R16UI),I===i.UNSIGNED_INT&&(k=i.R32UI),I===i.BYTE&&(k=i.R8I),I===i.SHORT&&(k=i.R16I),I===i.INT&&(k=i.R32I)),d===i.RG&&(I===i.FLOAT&&(k=i.RG32F),I===i.HALF_FLOAT&&(k=i.RG16F),I===i.UNSIGNED_BYTE&&(k=i.RG8),I===i.UNSIGNED_SHORT&&Q&&(k=Q.RG16_EXT),I===i.SHORT&&Q&&(k=Q.RG16_SNORM_EXT)),d===i.RG_INTEGER&&(I===i.UNSIGNED_BYTE&&(k=i.RG8UI),I===i.UNSIGNED_SHORT&&(k=i.RG16UI),I===i.UNSIGNED_INT&&(k=i.RG32UI),I===i.BYTE&&(k=i.RG8I),I===i.SHORT&&(k=i.RG16I),I===i.INT&&(k=i.RG32I)),d===i.RGB_INTEGER&&(I===i.UNSIGNED_BYTE&&(k=i.RGB8UI),I===i.UNSIGNED_SHORT&&(k=i.RGB16UI),I===i.UNSIGNED_INT&&(k=i.RGB32UI),I===i.BYTE&&(k=i.RGB8I),I===i.SHORT&&(k=i.RGB16I),I===i.INT&&(k=i.RGB32I)),d===i.RGBA_INTEGER&&(I===i.UNSIGNED_BYTE&&(k=i.RGBA8UI),I===i.UNSIGNED_SHORT&&(k=i.RGBA16UI),I===i.UNSIGNED_INT&&(k=i.RGBA32UI),I===i.BYTE&&(k=i.RGBA8I),I===i.SHORT&&(k=i.RGBA16I),I===i.INT&&(k=i.RGBA32I)),d===i.RGB&&(I===i.UNSIGNED_SHORT&&Q&&(k=Q.RGB16_EXT),I===i.SHORT&&Q&&(k=Q.RGB16_SNORM_EXT),I===i.UNSIGNED_INT_5_9_9_9_REV&&(k=i.RGB9_E5),I===i.UNSIGNED_INT_10F_11F_11F_REV&&(k=i.R11F_G11F_B10F)),d===i.RGBA){const X=ee?br:Xe.getTransfer(Z);I===i.FLOAT&&(k=i.RGBA32F),I===i.HALF_FLOAT&&(k=i.RGBA16F),I===i.UNSIGNED_BYTE&&(k=X===et?i.SRGB8_ALPHA8:i.RGBA8),I===i.UNSIGNED_SHORT&&Q&&(k=Q.RGBA16_EXT),I===i.SHORT&&Q&&(k=Q.RGBA16_SNORM_EXT),I===i.UNSIGNED_SHORT_4_4_4_4&&(k=i.RGBA4),I===i.UNSIGNED_SHORT_5_5_5_1&&(k=i.RGB5_A1)}return(k===i.R16F||k===i.R32F||k===i.RG16F||k===i.RG32F||k===i.RGBA16F||k===i.RGBA32F)&&e.get("EXT_color_buffer_float"),k}function R(M,d){let I;return M?d===null||d===rn||d===Oi?I=i.DEPTH24_STENCIL8:d===Jt?I=i.DEPTH32F_STENCIL8:d===Fi&&(I=i.DEPTH24_STENCIL8,Ie("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):d===null||d===rn||d===Oi?I=i.DEPTH_COMPONENT24:d===Jt?I=i.DEPTH_COMPONENT32F:d===Fi&&(I=i.DEPTH_COMPONENT16),I}function b(M,d){return h(M)===!0||M.isFramebufferTexture&&M.minFilter!==Et&&M.minFilter!==At?Math.log2(Math.max(d.width,d.height))+1:M.mipmaps!==void 0&&M.mipmaps.length>0?M.mipmaps.length:M.isCompressedTexture&&Array.isArray(M.image)?d.mipmaps.length:1}function D(M){const d=M.target;d.removeEventListener("dispose",D),A(d),d.isVideoTexture&&f.delete(d),d.isHTMLTexture&&m.delete(d)}function g(M){const d=M.target;d.removeEventListener("dispose",g),w(d)}function A(M){const d=n.get(M);if(d.__webglInit===void 0)return;const I=M.source,q=_.get(I);if(q){const Z=q[d.__cacheKey];Z.usedTimes--,Z.usedTimes===0&&L(M),Object.keys(q).length===0&&_.delete(I)}n.remove(M)}function L(M){const d=n.get(M);i.deleteTexture(d.__webglTexture);const I=M.source,q=_.get(I);delete q[d.__cacheKey],a.memory.textures--}function w(M){const d=n.get(M);if(M.depthTexture&&(M.depthTexture.dispose(),n.remove(M.depthTexture)),M.isWebGLCubeRenderTarget)for(let q=0;q<6;q++){if(Array.isArray(d.__webglFramebuffer[q]))for(let Z=0;Z<d.__webglFramebuffer[q].length;Z++)i.deleteFramebuffer(d.__webglFramebuffer[q][Z]);else i.deleteFramebuffer(d.__webglFramebuffer[q]);d.__webglDepthbuffer&&i.deleteRenderbuffer(d.__webglDepthbuffer[q])}else{if(Array.isArray(d.__webglFramebuffer))for(let q=0;q<d.__webglFramebuffer.length;q++)i.deleteFramebuffer(d.__webglFramebuffer[q]);else i.deleteFramebuffer(d.__webglFramebuffer);if(d.__webglDepthbuffer&&i.deleteRenderbuffer(d.__webglDepthbuffer),d.__webglMultisampledFramebuffer&&i.deleteFramebuffer(d.__webglMultisampledFramebuffer),d.__webglColorRenderbuffer)for(let q=0;q<d.__webglColorRenderbuffer.length;q++)d.__webglColorRenderbuffer[q]&&i.deleteRenderbuffer(d.__webglColorRenderbuffer[q]);d.__webglDepthRenderbuffer&&i.deleteRenderbuffer(d.__webglDepthRenderbuffer)}const I=M.textures;for(let q=0,Z=I.length;q<Z;q++){const ee=n.get(I[q]);ee.__webglTexture&&(i.deleteTexture(ee.__webglTexture),a.memory.textures--),n.remove(I[q])}n.remove(M)}let F=0;function W(){F=0}function Y(){return F}function N(M){F=M}function B(){const M=F;return M>=r.maxTextures&&Ie("WebGLTextures: Trying to use "+M+" texture units while this GPU supports only "+r.maxTextures),F+=1,M}function V(M){const d=[];return d.push(M.wrapS),d.push(M.wrapT),d.push(M.wrapR||0),d.push(M.magFilter),d.push(M.minFilter),d.push(M.anisotropy),d.push(M.internalFormat),d.push(M.format),d.push(M.type),d.push(M.generateMipmaps),d.push(M.premultiplyAlpha),d.push(M.flipY),d.push(M.unpackAlignment),d.push(M.colorSpace),d.join()}function J(M,d){const I=n.get(M);if(M.isVideoTexture&&Ye(M),M.isRenderTargetTexture===!1&&M.isExternalTexture!==!0&&M.version>0&&I.__version!==M.version){const q=M.image;if(q===null)Ie("WebGLRenderer: Texture marked for update but no image data found.");else if(q.complete===!1)Ie("WebGLRenderer: Texture marked for update but image is incomplete");else{ye(I,M,d);return}}else M.isExternalTexture&&(I.__webglTexture=M.sourceTexture?M.sourceTexture:null);t.bindTexture(i.TEXTURE_2D,I.__webglTexture,i.TEXTURE0+d)}function ne(M,d){const I=n.get(M);if(M.isRenderTargetTexture===!1&&M.version>0&&I.__version!==M.version){ye(I,M,d);return}else M.isExternalTexture&&(I.__webglTexture=M.sourceTexture?M.sourceTexture:null);t.bindTexture(i.TEXTURE_2D_ARRAY,I.__webglTexture,i.TEXTURE0+d)}function oe(M,d){const I=n.get(M);if(M.isRenderTargetTexture===!1&&M.version>0&&I.__version!==M.version){ye(I,M,d);return}t.bindTexture(i.TEXTURE_3D,I.__webglTexture,i.TEXTURE0+d)}function ve(M,d){const I=n.get(M);if(M.isCubeDepthTexture!==!0&&M.version>0&&I.__version!==M.version){De(I,M,d);return}t.bindTexture(i.TEXTURE_CUBE_MAP,I.__webglTexture,i.TEXTURE0+d)}const Ee={[Ts]:i.REPEAT,[_n]:i.CLAMP_TO_EDGE,[As]:i.MIRRORED_REPEAT},ke={[Et]:i.NEAREST,[cc]:i.NEAREST_MIPMAP_NEAREST,[Xi]:i.NEAREST_MIPMAP_LINEAR,[At]:i.LINEAR,[Or]:i.LINEAR_MIPMAP_NEAREST,[qn]:i.LINEAR_MIPMAP_LINEAR},Ve={[fc]:i.NEVER,[gc]:i.ALWAYS,[dc]:i.LESS,[ga]:i.LEQUAL,[pc]:i.EQUAL,[xa]:i.GEQUAL,[mc]:i.GREATER,[_c]:i.NOTEQUAL};function Le(M,d){if(d.type===Jt&&e.has("OES_texture_float_linear")===!1&&(d.magFilter===At||d.magFilter===Or||d.magFilter===Xi||d.magFilter===qn||d.minFilter===At||d.minFilter===Or||d.minFilter===Xi||d.minFilter===qn)&&Ie("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(M,i.TEXTURE_WRAP_S,Ee[d.wrapS]),i.texParameteri(M,i.TEXTURE_WRAP_T,Ee[d.wrapT]),(M===i.TEXTURE_3D||M===i.TEXTURE_2D_ARRAY)&&i.texParameteri(M,i.TEXTURE_WRAP_R,Ee[d.wrapR]),i.texParameteri(M,i.TEXTURE_MAG_FILTER,ke[d.magFilter]),i.texParameteri(M,i.TEXTURE_MIN_FILTER,ke[d.minFilter]),d.compareFunction&&(i.texParameteri(M,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(M,i.TEXTURE_COMPARE_FUNC,Ve[d.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(d.magFilter===Et||d.minFilter!==Xi&&d.minFilter!==qn||d.type===Jt&&e.has("OES_texture_float_linear")===!1)return;if(d.anisotropy>1||n.get(d).__currentAnisotropy){const I=e.get("EXT_texture_filter_anisotropic");i.texParameterf(M,I.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(d.anisotropy,r.getMaxAnisotropy())),n.get(d).__currentAnisotropy=d.anisotropy}}}function K(M,d){let I=!1;M.__webglInit===void 0&&(M.__webglInit=!0,d.addEventListener("dispose",D));const q=d.source;let Z=_.get(q);Z===void 0&&(Z={},_.set(q,Z));const ee=V(d);if(ee!==M.__cacheKey){Z[ee]===void 0&&(Z[ee]={texture:i.createTexture(),usedTimes:0},a.memory.textures++,I=!0),Z[ee].usedTimes++;const Q=Z[M.__cacheKey];Q!==void 0&&(Z[M.__cacheKey].usedTimes--,Q.usedTimes===0&&L(d)),M.__cacheKey=ee,M.__webglTexture=Z[ee].texture}return I}function le(M,d,I){return Math.floor(Math.floor(M/I)/d)}function ie(M,d,I,q){const ee=M.updateRanges;if(ee.length===0)t.texSubImage2D(i.TEXTURE_2D,0,0,0,d.width,d.height,I,q,d.data);else{ee.sort((_e,re)=>_e.start-re.start);let Q=0;for(let _e=1;_e<ee.length;_e++){const re=ee[Q],se=ee[_e],Ue=re.start+re.count,Ge=le(se.start,d.width,4),Je=le(re.start,d.width,4);se.start<=Ue+1&&Ge===Je&&le(se.start+se.count-1,d.width,4)===Ge?re.count=Math.max(re.count,se.start+se.count-re.start):(++Q,ee[Q]=se)}ee.length=Q+1;const k=t.getParameter(i.UNPACK_ROW_LENGTH),X=t.getParameter(i.UNPACK_SKIP_PIXELS),he=t.getParameter(i.UNPACK_SKIP_ROWS);t.pixelStorei(i.UNPACK_ROW_LENGTH,d.width);for(let _e=0,re=ee.length;_e<re;_e++){const se=ee[_e],Ue=Math.floor(se.start/4),Ge=Math.ceil(se.count/4),Je=Ue%d.width,P=Math.floor(Ue/d.width),ae=Ge,$=1;t.pixelStorei(i.UNPACK_SKIP_PIXELS,Je),t.pixelStorei(i.UNPACK_SKIP_ROWS,P),t.texSubImage2D(i.TEXTURE_2D,0,Je,P,ae,$,I,q,d.data)}M.clearUpdateRanges(),t.pixelStorei(i.UNPACK_ROW_LENGTH,k),t.pixelStorei(i.UNPACK_SKIP_PIXELS,X),t.pixelStorei(i.UNPACK_SKIP_ROWS,he)}}function ye(M,d,I){let q=i.TEXTURE_2D;(d.isDataArrayTexture||d.isCompressedArrayTexture)&&(q=i.TEXTURE_2D_ARRAY),d.isData3DTexture&&(q=i.TEXTURE_3D);const Z=K(M,d),ee=d.source;t.bindTexture(q,M.__webglTexture,i.TEXTURE0+I);const Q=n.get(ee);if(ee.version!==Q.__version||Z===!0){if(t.activeTexture(i.TEXTURE0+I),(typeof ImageBitmap<"u"&&d.image instanceof ImageBitmap)===!1){const $=Xe.getPrimaries(Xe.workingColorSpace),xe=d.colorSpace===Dn?null:Xe.getPrimaries(d.colorSpace),ce=d.colorSpace===Dn||$===xe?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,d.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,d.premultiplyAlpha),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,ce)}t.pixelStorei(i.UNPACK_ALIGNMENT,d.unpackAlignment);let X=p(d.image,!1,r.maxTextureSize);X=ue(d,X);const he=s.convert(d.format,d.colorSpace),_e=s.convert(d.type);let re=E(d.internalFormat,he,_e,d.normalized,d.colorSpace,d.isVideoTexture);Le(q,d);let se;const Ue=d.mipmaps,Ge=d.isVideoTexture!==!0,Je=Q.__version===void 0||Z===!0,P=ee.dataReady,ae=b(d,X);if(d.isDepthTexture)re=R(d.format===Yn,d.type),Je&&(Ge?t.texStorage2D(i.TEXTURE_2D,1,re,X.width,X.height):t.texImage2D(i.TEXTURE_2D,0,re,X.width,X.height,0,he,_e,null));else if(d.isDataTexture)if(Ue.length>0){Ge&&Je&&t.texStorage2D(i.TEXTURE_2D,ae,re,Ue[0].width,Ue[0].height);for(let $=0,xe=Ue.length;$<xe;$++)se=Ue[$],Ge?P&&t.texSubImage2D(i.TEXTURE_2D,$,0,0,se.width,se.height,he,_e,se.data):t.texImage2D(i.TEXTURE_2D,$,re,se.width,se.height,0,he,_e,se.data);d.generateMipmaps=!1}else Ge?(Je&&t.texStorage2D(i.TEXTURE_2D,ae,re,X.width,X.height),P&&ie(d,X,he,_e)):t.texImage2D(i.TEXTURE_2D,0,re,X.width,X.height,0,he,_e,X.data);else if(d.isCompressedTexture)if(d.isCompressedArrayTexture){Ge&&Je&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ae,re,Ue[0].width,Ue[0].height,X.depth);for(let $=0,xe=Ue.length;$<xe;$++)if(se=Ue[$],d.format!==qt)if(he!==null)if(Ge){if(P)if(d.layerUpdates.size>0){const ce=Mo(se.width,se.height,d.format,d.type);for(const te of d.layerUpdates){const Ae=se.data.subarray(te*ce/se.data.BYTES_PER_ELEMENT,(te+1)*ce/se.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,$,0,0,te,se.width,se.height,1,he,Ae)}d.clearLayerUpdates()}else t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,$,0,0,0,se.width,se.height,X.depth,he,se.data)}else t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,$,re,se.width,se.height,X.depth,0,se.data,0,0);else Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ge?P&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,$,0,0,0,se.width,se.height,X.depth,he,_e,se.data):t.texImage3D(i.TEXTURE_2D_ARRAY,$,re,se.width,se.height,X.depth,0,he,_e,se.data)}else{Ge&&Je&&t.texStorage2D(i.TEXTURE_2D,ae,re,Ue[0].width,Ue[0].height);for(let $=0,xe=Ue.length;$<xe;$++)se=Ue[$],d.format!==qt?he!==null?Ge?P&&t.compressedTexSubImage2D(i.TEXTURE_2D,$,0,0,se.width,se.height,he,se.data):t.compressedTexImage2D(i.TEXTURE_2D,$,re,se.width,se.height,0,se.data):Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ge?P&&t.texSubImage2D(i.TEXTURE_2D,$,0,0,se.width,se.height,he,_e,se.data):t.texImage2D(i.TEXTURE_2D,$,re,se.width,se.height,0,he,_e,se.data)}else if(d.isDataArrayTexture)if(Ge){if(Je&&t.texStorage3D(i.TEXTURE_2D_ARRAY,ae,re,X.width,X.height,X.depth),P)if(d.layerUpdates.size>0){const $=Mo(X.width,X.height,d.format,d.type);for(const xe of d.layerUpdates){const ce=X.data.subarray(xe*$/X.data.BYTES_PER_ELEMENT,(xe+1)*$/X.data.BYTES_PER_ELEMENT);t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,xe,X.width,X.height,1,he,_e,ce)}d.clearLayerUpdates()}else t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,X.width,X.height,X.depth,he,_e,X.data)}else t.texImage3D(i.TEXTURE_2D_ARRAY,0,re,X.width,X.height,X.depth,0,he,_e,X.data);else if(d.isData3DTexture)Ge?(Je&&t.texStorage3D(i.TEXTURE_3D,ae,re,X.width,X.height,X.depth),P&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,X.width,X.height,X.depth,he,_e,X.data)):t.texImage3D(i.TEXTURE_3D,0,re,X.width,X.height,X.depth,0,he,_e,X.data);else if(d.isFramebufferTexture){if(Je)if(Ge)t.texStorage2D(i.TEXTURE_2D,ae,re,X.width,X.height);else{let $=X.width,xe=X.height;for(let ce=0;ce<ae;ce++)t.texImage2D(i.TEXTURE_2D,ce,re,$,xe,0,he,_e,null),$>>=1,xe>>=1}}else if(d.isHTMLTexture){if("texElementImage2D"in i){const $=i.canvas;if($.hasAttribute("layoutsubtree")||$.setAttribute("layoutsubtree","true"),X.parentNode!==$){$.appendChild(X),m.add(d),$.onpaint=Be=>{const ft=Be.changedElements;for(const tt of m)ft.includes(tt.image)&&(tt.needsUpdate=!0)},$.requestPaint();return}const xe=0,ce=i.RGBA,te=i.RGBA,Ae=i.UNSIGNED_BYTE;i.texElementImage2D(i.TEXTURE_2D,xe,ce,te,Ae,X),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_MIN_FILTER,i.LINEAR),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_S,i.CLAMP_TO_EDGE),i.texParameteri(i.TEXTURE_2D,i.TEXTURE_WRAP_T,i.CLAMP_TO_EDGE)}}else if(Ue.length>0){if(Ge&&Je){const $=Pe(Ue[0]);t.texStorage2D(i.TEXTURE_2D,ae,re,$.width,$.height)}for(let $=0,xe=Ue.length;$<xe;$++)se=Ue[$],Ge?P&&t.texSubImage2D(i.TEXTURE_2D,$,0,0,he,_e,se):t.texImage2D(i.TEXTURE_2D,$,re,he,_e,se);d.generateMipmaps=!1}else if(Ge){if(Je){const $=Pe(X);t.texStorage2D(i.TEXTURE_2D,ae,re,$.width,$.height)}P&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,he,_e,X)}else t.texImage2D(i.TEXTURE_2D,0,re,he,_e,X);h(d)&&S(q),Q.__version=ee.version,d.onUpdate&&d.onUpdate(d)}M.__version=d.version}function De(M,d,I){if(d.image.length!==6)return;const q=K(M,d),Z=d.source;t.bindTexture(i.TEXTURE_CUBE_MAP,M.__webglTexture,i.TEXTURE0+I);const ee=n.get(Z);if(Z.version!==ee.__version||q===!0){t.activeTexture(i.TEXTURE0+I);const Q=Xe.getPrimaries(Xe.workingColorSpace),k=d.colorSpace===Dn?null:Xe.getPrimaries(d.colorSpace),X=d.colorSpace===Dn||Q===k?i.NONE:i.BROWSER_DEFAULT_WEBGL;t.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,d.flipY),t.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,d.premultiplyAlpha),t.pixelStorei(i.UNPACK_ALIGNMENT,d.unpackAlignment),t.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,X);const he=d.isCompressedTexture||d.image[0].isCompressedTexture,_e=d.image[0]&&d.image[0].isDataTexture,re=[];for(let te=0;te<6;te++)!he&&!_e?re[te]=p(d.image[te],!0,r.maxCubemapSize):re[te]=_e?d.image[te].image:d.image[te],re[te]=ue(d,re[te]);const se=re[0],Ue=s.convert(d.format,d.colorSpace),Ge=s.convert(d.type),Je=E(d.internalFormat,Ue,Ge,d.normalized,d.colorSpace),P=d.isVideoTexture!==!0,ae=ee.__version===void 0||q===!0,$=Z.dataReady;let xe=b(d,se);Le(i.TEXTURE_CUBE_MAP,d);let ce;if(he){P&&ae&&t.texStorage2D(i.TEXTURE_CUBE_MAP,xe,Je,se.width,se.height);for(let te=0;te<6;te++){ce=re[te].mipmaps;for(let Ae=0;Ae<ce.length;Ae++){const Be=ce[Ae];d.format!==qt?Ue!==null?P?$&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ae,0,0,Be.width,Be.height,Ue,Be.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ae,Je,Be.width,Be.height,0,Be.data):Ie("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):P?$&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ae,0,0,Be.width,Be.height,Ue,Ge,Be.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ae,Je,Be.width,Be.height,0,Ue,Ge,Be.data)}}}else{if(ce=d.mipmaps,P&&ae){ce.length>0&&xe++;const te=Pe(re[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,xe,Je,te.width,te.height)}for(let te=0;te<6;te++)if(_e){P?$&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,0,0,re[te].width,re[te].height,Ue,Ge,re[te].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,Je,re[te].width,re[te].height,0,Ue,Ge,re[te].data);for(let Ae=0;Ae<ce.length;Ae++){const ft=ce[Ae].image[te].image;P?$&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ae+1,0,0,ft.width,ft.height,Ue,Ge,ft.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ae+1,Je,ft.width,ft.height,0,Ue,Ge,ft.data)}}else{P?$&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,0,0,Ue,Ge,re[te]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,0,Je,Ue,Ge,re[te]);for(let Ae=0;Ae<ce.length;Ae++){const Be=ce[Ae];P?$&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ae+1,0,0,Ue,Ge,Be.image[te]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+te,Ae+1,Je,Ue,Ge,Be.image[te])}}}h(d)&&S(i.TEXTURE_CUBE_MAP),ee.__version=Z.version,d.onUpdate&&d.onUpdate(d)}M.__version=d.version}function we(M,d,I,q,Z,ee){const Q=s.convert(I.format,I.colorSpace),k=s.convert(I.type),X=E(I.internalFormat,Q,k,I.normalized,I.colorSpace),he=n.get(d),_e=n.get(I);if(_e.__renderTarget=d,!he.__hasExternalTextures){const re=Math.max(1,d.width>>ee),se=Math.max(1,d.height>>ee);Z===i.TEXTURE_3D||Z===i.TEXTURE_2D_ARRAY?t.texImage3D(Z,ee,X,re,se,d.depth,0,Q,k,null):t.texImage2D(Z,ee,X,re,se,0,Q,k,null)}t.bindFramebuffer(i.FRAMEBUFFER,M),Oe(d)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,q,Z,_e.__webglTexture,0,rt(d)):(Z===i.TEXTURE_2D||Z>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Z<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,q,Z,_e.__webglTexture,ee),t.bindFramebuffer(i.FRAMEBUFFER,null)}function it(M,d,I){if(i.bindRenderbuffer(i.RENDERBUFFER,M),d.depthBuffer){const q=d.depthTexture,Z=q&&q.isDepthTexture?q.type:null,ee=R(d.stencilBuffer,Z),Q=d.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;Oe(d)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,rt(d),ee,d.width,d.height):I?i.renderbufferStorageMultisample(i.RENDERBUFFER,rt(d),ee,d.width,d.height):i.renderbufferStorage(i.RENDERBUFFER,ee,d.width,d.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,Q,i.RENDERBUFFER,M)}else{const q=d.textures;for(let Z=0;Z<q.length;Z++){const ee=q[Z],Q=s.convert(ee.format,ee.colorSpace),k=s.convert(ee.type),X=E(ee.internalFormat,Q,k,ee.normalized,ee.colorSpace);Oe(d)?o.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,rt(d),X,d.width,d.height):I?i.renderbufferStorageMultisample(i.RENDERBUFFER,rt(d),X,d.width,d.height):i.renderbufferStorage(i.RENDERBUFFER,X,d.width,d.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function j(M,d,I){const q=d.isWebGLCubeRenderTarget===!0;if(t.bindFramebuffer(i.FRAMEBUFFER,M),!(d.depthTexture&&d.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Z=n.get(d.depthTexture);if(Z.__renderTarget=d,(!Z.__webglTexture||d.depthTexture.image.width!==d.width||d.depthTexture.image.height!==d.height)&&(d.depthTexture.image.width=d.width,d.depthTexture.image.height=d.height,d.depthTexture.needsUpdate=!0),q){if(Z.__webglInit===void 0&&(Z.__webglInit=!0,d.depthTexture.addEventListener("dispose",D)),Z.__webglTexture===void 0){Z.__webglTexture=i.createTexture(),t.bindTexture(i.TEXTURE_CUBE_MAP,Z.__webglTexture),Le(i.TEXTURE_CUBE_MAP,d.depthTexture);const he=s.convert(d.depthTexture.format),_e=s.convert(d.depthTexture.type);let re;d.depthTexture.format===Mn?re=i.DEPTH_COMPONENT24:d.depthTexture.format===Yn&&(re=i.DEPTH24_STENCIL8);for(let se=0;se<6;se++)i.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+se,0,re,d.width,d.height,0,he,_e,null)}}else J(d.depthTexture,0);const ee=Z.__webglTexture,Q=rt(d),k=q?i.TEXTURE_CUBE_MAP_POSITIVE_X+I:i.TEXTURE_2D,X=d.depthTexture.format===Yn?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;if(d.depthTexture.format===Mn)Oe(d)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,X,k,ee,0,Q):i.framebufferTexture2D(i.FRAMEBUFFER,X,k,ee,0);else if(d.depthTexture.format===Yn)Oe(d)?o.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,X,k,ee,0,Q):i.framebufferTexture2D(i.FRAMEBUFFER,X,k,ee,0);else throw new Error("Unknown depthTexture format")}function ge(M){const d=n.get(M),I=M.isWebGLCubeRenderTarget===!0;if(d.__boundDepthTexture!==M.depthTexture){const q=M.depthTexture;if(d.__depthDisposeCallback&&d.__depthDisposeCallback(),q){const Z=()=>{delete d.__boundDepthTexture,delete d.__depthDisposeCallback,q.removeEventListener("dispose",Z)};q.addEventListener("dispose",Z),d.__depthDisposeCallback=Z}d.__boundDepthTexture=q}if(M.depthTexture&&!d.__autoAllocateDepthBuffer)if(I)for(let q=0;q<6;q++)j(d.__webglFramebuffer[q],M,q);else{const q=M.texture.mipmaps;q&&q.length>0?j(d.__webglFramebuffer[0],M,0):j(d.__webglFramebuffer,M,0)}else if(I){d.__webglDepthbuffer=[];for(let q=0;q<6;q++)if(t.bindFramebuffer(i.FRAMEBUFFER,d.__webglFramebuffer[q]),d.__webglDepthbuffer[q]===void 0)d.__webglDepthbuffer[q]=i.createRenderbuffer(),it(d.__webglDepthbuffer[q],M,!1);else{const Z=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ee=d.__webglDepthbuffer[q];i.bindRenderbuffer(i.RENDERBUFFER,ee),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,ee)}}else{const q=M.texture.mipmaps;if(q&&q.length>0?t.bindFramebuffer(i.FRAMEBUFFER,d.__webglFramebuffer[0]):t.bindFramebuffer(i.FRAMEBUFFER,d.__webglFramebuffer),d.__webglDepthbuffer===void 0)d.__webglDepthbuffer=i.createRenderbuffer(),it(d.__webglDepthbuffer,M,!1);else{const Z=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ee=d.__webglDepthbuffer;i.bindRenderbuffer(i.RENDERBUFFER,ee),i.framebufferRenderbuffer(i.FRAMEBUFFER,Z,i.RENDERBUFFER,ee)}}t.bindFramebuffer(i.FRAMEBUFFER,null)}function fe(M,d,I){const q=n.get(M);d!==void 0&&we(q.__webglFramebuffer,M,M.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),I!==void 0&&ge(M)}function Te(M){const d=M.texture,I=n.get(M),q=n.get(d);M.addEventListener("dispose",g);const Z=M.textures,ee=M.isWebGLCubeRenderTarget===!0,Q=Z.length>1;if(Q||(q.__webglTexture===void 0&&(q.__webglTexture=i.createTexture()),q.__version=d.version,a.memory.textures++),ee){I.__webglFramebuffer=[];for(let k=0;k<6;k++)if(d.mipmaps&&d.mipmaps.length>0){I.__webglFramebuffer[k]=[];for(let X=0;X<d.mipmaps.length;X++)I.__webglFramebuffer[k][X]=i.createFramebuffer()}else I.__webglFramebuffer[k]=i.createFramebuffer()}else{if(d.mipmaps&&d.mipmaps.length>0){I.__webglFramebuffer=[];for(let k=0;k<d.mipmaps.length;k++)I.__webglFramebuffer[k]=i.createFramebuffer()}else I.__webglFramebuffer=i.createFramebuffer();if(Q)for(let k=0,X=Z.length;k<X;k++){const he=n.get(Z[k]);he.__webglTexture===void 0&&(he.__webglTexture=i.createTexture(),a.memory.textures++)}if(M.samples>0&&Oe(M)===!1){I.__webglMultisampledFramebuffer=i.createFramebuffer(),I.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,I.__webglMultisampledFramebuffer);for(let k=0;k<Z.length;k++){const X=Z[k];I.__webglColorRenderbuffer[k]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,I.__webglColorRenderbuffer[k]);const he=s.convert(X.format,X.colorSpace),_e=s.convert(X.type),re=E(X.internalFormat,he,_e,X.normalized,X.colorSpace,M.isXRRenderTarget===!0),se=rt(M);i.renderbufferStorageMultisample(i.RENDERBUFFER,se,re,M.width,M.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+k,i.RENDERBUFFER,I.__webglColorRenderbuffer[k])}i.bindRenderbuffer(i.RENDERBUFFER,null),M.depthBuffer&&(I.__webglDepthRenderbuffer=i.createRenderbuffer(),it(I.__webglDepthRenderbuffer,M,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ee){t.bindTexture(i.TEXTURE_CUBE_MAP,q.__webglTexture),Le(i.TEXTURE_CUBE_MAP,d);for(let k=0;k<6;k++)if(d.mipmaps&&d.mipmaps.length>0)for(let X=0;X<d.mipmaps.length;X++)we(I.__webglFramebuffer[k][X],M,d,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+k,X);else we(I.__webglFramebuffer[k],M,d,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+k,0);h(d)&&S(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Q){for(let k=0,X=Z.length;k<X;k++){const he=Z[k],_e=n.get(he);let re=i.TEXTURE_2D;(M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(re=M.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(re,_e.__webglTexture),Le(re,he),we(I.__webglFramebuffer,M,he,i.COLOR_ATTACHMENT0+k,re,0),h(he)&&S(re)}t.unbindTexture()}else{let k=i.TEXTURE_2D;if((M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(k=M.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(k,q.__webglTexture),Le(k,d),d.mipmaps&&d.mipmaps.length>0)for(let X=0;X<d.mipmaps.length;X++)we(I.__webglFramebuffer[X],M,d,i.COLOR_ATTACHMENT0,k,X);else we(I.__webglFramebuffer,M,d,i.COLOR_ATTACHMENT0,k,0);h(d)&&S(k),t.unbindTexture()}M.depthBuffer&&ge(M)}function Fe(M){const d=M.textures;for(let I=0,q=d.length;I<q;I++){const Z=d[I];if(h(Z)){const ee=T(M),Q=n.get(Z).__webglTexture;t.bindTexture(ee,Q),S(ee),t.unbindTexture()}}}const Qe=[],vt=[];function C(M){if(M.samples>0){if(Oe(M)===!1){const d=M.textures,I=M.width,q=M.height;let Z=i.COLOR_BUFFER_BIT;const ee=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,Q=n.get(M),k=d.length>1;if(k)for(let he=0;he<d.length;he++)t.bindFramebuffer(i.FRAMEBUFFER,Q.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+he,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,Q.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+he,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,Q.__webglMultisampledFramebuffer);const X=M.texture.mipmaps;X&&X.length>0?t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Q.__webglFramebuffer[0]):t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Q.__webglFramebuffer);for(let he=0;he<d.length;he++){if(M.resolveDepthBuffer&&(M.depthBuffer&&(Z|=i.DEPTH_BUFFER_BIT),M.stencilBuffer&&M.resolveStencilBuffer&&(Z|=i.STENCIL_BUFFER_BIT)),k){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,Q.__webglColorRenderbuffer[he]);const _e=n.get(d[he]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,_e,0)}i.blitFramebuffer(0,0,I,q,0,0,I,q,Z,i.NEAREST),c===!0&&(Qe.length=0,vt.length=0,Qe.push(i.COLOR_ATTACHMENT0+he),M.depthBuffer&&M.resolveDepthBuffer===!1&&(Qe.push(ee),vt.push(ee),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,vt)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Qe))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),k)for(let he=0;he<d.length;he++){t.bindFramebuffer(i.FRAMEBUFFER,Q.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+he,i.RENDERBUFFER,Q.__webglColorRenderbuffer[he]);const _e=n.get(d[he]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,Q.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+he,i.TEXTURE_2D,_e,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,Q.__webglMultisampledFramebuffer)}else if(M.depthBuffer&&M.resolveDepthBuffer===!1&&c){const d=M.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[d])}}}function rt(M){return Math.min(r.maxSamples,M.samples)}function Oe(M){const d=n.get(M);return M.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&d.__useRenderToTexture!==!1}function Ye(M){const d=a.render.frame;f.get(M)!==d&&(f.set(M,d),M.update())}function ue(M,d){const I=M.colorSpace,q=M.format,Z=M.type;return M.isCompressedTexture===!0||M.isVideoTexture===!0||I!==yr&&I!==Dn&&(Xe.getTransfer(I)===et?(q!==qt||Z!==Ot)&&Ie("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):$e("WebGLTextures: Unsupported texture color space:",I)),d}function Pe(M){return typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement?(l.width=M.naturalWidth||M.width,l.height=M.naturalHeight||M.height):typeof VideoFrame<"u"&&M instanceof VideoFrame?(l.width=M.displayWidth,l.height=M.displayHeight):(l.width=M.width,l.height=M.height),l}this.allocateTextureUnit=B,this.resetTextureUnits=W,this.getTextureUnits=Y,this.setTextureUnits=N,this.setTexture2D=J,this.setTexture2DArray=ne,this.setTexture3D=oe,this.setTextureCube=ve,this.rebindTextures=fe,this.setupRenderTarget=Te,this.updateRenderTargetMipmap=Fe,this.updateMultisampleRenderTarget=C,this.setupDepthRenderbuffer=ge,this.setupFrameBufferTexture=we,this.useMultisampledRTT=Oe,this.isReversedDepthBuffer=function(){return t.buffers.depth.getReversed()}}function qp(i,e){function t(n,r=Dn){let s;const a=Xe.getTransfer(r);if(n===Ot)return i.UNSIGNED_BYTE;if(n===fa)return i.UNSIGNED_SHORT_4_4_4_4;if(n===da)return i.UNSIGNED_SHORT_5_5_5_1;if(n===el)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===tl)return i.UNSIGNED_INT_10F_11F_11F_REV;if(n===Jo)return i.BYTE;if(n===Qo)return i.SHORT;if(n===Fi)return i.UNSIGNED_SHORT;if(n===ha)return i.INT;if(n===rn)return i.UNSIGNED_INT;if(n===Jt)return i.FLOAT;if(n===vn)return i.HALF_FLOAT;if(n===nl)return i.ALPHA;if(n===il)return i.RGB;if(n===qt)return i.RGBA;if(n===Mn)return i.DEPTH_COMPONENT;if(n===Yn)return i.DEPTH_STENCIL;if(n===rl)return i.RED;if(n===pa)return i.RED_INTEGER;if(n===Kn)return i.RG;if(n===ma)return i.RG_INTEGER;if(n===_a)return i.RGBA_INTEGER;if(n===_r||n===gr||n===xr||n===vr)if(a===et)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===_r)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===gr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===xr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===vr)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===_r)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===gr)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===xr)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===vr)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===ws||n===Rs||n===Cs||n===Ps)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===ws)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Rs)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===Cs)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Ps)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Ds||n===Ls||n===Is||n===Us||n===Ns||n===Sr||n===Fs)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===Ds||n===Ls)return a===et?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Is)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(n===Us)return s.COMPRESSED_R11_EAC;if(n===Ns)return s.COMPRESSED_SIGNED_R11_EAC;if(n===Sr)return s.COMPRESSED_RG11_EAC;if(n===Fs)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(n===Os||n===Bs||n===zs||n===Gs||n===Vs||n===Hs||n===ks||n===Ws||n===Xs||n===qs||n===Ys||n===$s||n===Ks||n===Zs)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===Os)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Bs)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===zs)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Gs)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Vs)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Hs)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===ks)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===Ws)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Xs)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===qs)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Ys)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===$s)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Ks)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Zs)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===js||n===Js||n===Qs)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===js)return a===et?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===Js)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Qs)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===ea||n===ta||n===Er||n===na)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===ea)return s.COMPRESSED_RED_RGTC1_EXT;if(n===ta)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Er)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===na)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Oi?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}const Yp=`
void main() {
...
}`;class Kp{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new fl(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new sn({vertexShader:Yp,fragmentShader:$p,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new lt(new Cr(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Zp extends jn{constructor(e,t){super();const n=this;let r=null,s=1,a=null,o="local-floor",c=1,l=null,f=null,m=null,u=null,_=null,v=null;const y=typeof XRWebGLBinding<"u",p=new Kp,h={},S=t.getContextAttributes();let T=null,E=null;const R=[],b=[],D=new je;let g=null;const A=new Vt;A.viewport=new ut;const L=new Vt;L.viewport=new ut;const w=[A,L],F=new ru;let W=null,Y=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(K){let le=R[K];return le===void 0&&(le=new Xr,R[K]=le),le.getTargetRaySpace()},this.getControllerGrip=function(K){let le=R[K];return le===void 0&&(le=new Xr,R[K]=le),le.getGripSpace()},this.getHand=function(K){let le=R[K];return le===void 0&&(le=new Xr,R[K]=le),le.getHandSpace()};function N(K){const le=b.indexOf(K.inputSource);if(le===-1)return;const ie=R[le];ie!==void 0&&(ie.update(K.inputSource,K.frame,l||a),ie.dispatchEvent({type:K.type,data:K.inputSource}))}function B(){r.removeEventListener("select",N),r.removeEventListener("selectstart",N),r.removeEventListener("selectend",N),r.removeEventListener("squeeze",N),r.removeEventListener("squeezestart",N),r.removeEventListener("squeezeend",N),r.removeEventListener("end",B),r.removeEventListener("inputsourceschange",V);for(let K=0;K<R.length;K++){const le=b[K];le!==null&&(b[K]=null,R[K].disconnect(le))}W=null,Y=null,p.reset();for(const K in h)delete h[K];e.setRenderTarget(T),_=null,u=null,m=null,r=null,E=null,Le.stop(),n.isPresenting=!1,e.setPixelRatio(g),e.setSize(D.width,D.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(K){s=K,n.isPresenting===!0&&Ie("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(K){o=K,n.isPresenting===!0&&Ie("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function(K){l=K},this.getBaseLayer=function(){return u!==null?u:_},this.getBinding=function(){return m===null&&y&&(m=new XRWebGLBinding(r,t)),m},this.getFrame=function(){return v},this.getSession=function(){return r},this.setSession=async function(K){if(r=K,r!==null){if(T=e.getRenderTarget(),r.addEventListener("select",N),r.addEventListener("selectstart",N),r.addEventListener("selectend",N),r.addEventListener("squeeze",N),r.addEventListener("squeezestart",N),r.addEventListener("squeezeend",N),r.addEventListener("end",B),r.addEventListener("inputsourceschange",V),S.xrCompatible!==!0&&await t.makeXRCompatible(),g=e.getPixelRatio(),e.getSize(D),y&&"createProjectionLayer"in XRWebGLBinding.prototype){let ie=null,ye=null,De=null;S.depth&&(De=S.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,ie=S.stencil?Yn:Mn,ye=S.stencil?Oi:rn);const we={colorFormat:t.RGBA8,depthFormat:De,scaleFactor:s};m=this.getBinding(),u=m.createProjectionLayer(we),r.updateRenderState({layers:[u]}),e.setPixelRatio(1),e.setSize(u.textureWidth,u.textureHeight,!1),E=new tn(u.textureWidth,u.textureHeight,{format:qt,type:Ot,depthTexture:new vi(u.textureWidth,u.textureHeight,ye,void 0,void 0,void 0,void 0,void 0,void 0,ie),stencilBuffer:S.stencil,colorSpace:e.outputColorSpace,samples:S.antialias?4:0,resolveDepthBuffer:u.ignoreDepthValues===!1,resolveStencilBuffer:u.ignoreDepthValues===!1})}else{const ie={antialias:S.antialias,alpha:!0,depth:S.depth,stencil:S.stencil,framebufferScaleFactor:s};_=new XRWebGLLayer(r,t,ie),r.updateRenderState({baseLayer:_}),e.setPixelRatio(1),e.setSize(_.framebufferWidth,_.framebufferHeight,!1),E=new tn(_.framebufferWidth,_.framebufferHeight,{format:qt,type:Ot,colorSpace:e.outputColorSpace,stencilBuffer:S.stencil,resolveDepthBuffer:_.ignoreDepthValues===!1,resolveStencilBuffer:_.ignoreDepthValues===!1})}E.isXRRenderTarget=!0,this.setFoveation(c),l=null,a=await r.requestReferenceSpace(o),Le.setContext(r),Le.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return p.getDepthTexture()};function V(K){for(let le=0;le<K.removed.length;le++){const ie=K.removed[le],ye=b.indexOf(ie);ye>=0&&(b[ye]=null,R[ye].disconnect(ie))}for(let le=0;le<K.added.length;le++){const ie=K.added[le];let ye=b.indexOf(ie);if(ye===-1){for(let we=0;we<R.length;we++)if(we>=b.length){b.push(ie),ye=we;break}else if(b[we]===null){b[we]=ie,ye=we;break}if(ye===-1)break}const De=R[ye];De&&De.connect(ie)}}const J=new O,ne=new O;function oe(K,le,ie){J.setFromMatrixPosition(le.matrixWorld),ne.setFromMatrixPosition(ie.matrixWorld);const ye=J.distanceTo(ne),De=le.projectionMatrix.elements,we=ie.projectionMatrix.elements,it=De[14]/(De[10]-1),j=De[14]/(De[10]+1),ge=(De[9]+1)/De[5],fe=(De[9]-1)/De[5],Te=(De[8]-1)/De[0],Fe=(we[8]+1)/we[0],Qe=it*Te,vt=it*Fe,C=ye/(-Te+Fe),rt=C*-Te;if(le.matrixWorld.decompose(K.position,K.quaternion,K.scale),K.translateX(rt),K.translateZ(C),K.matrixWorld.compose(K.position,K.quaternion,K.scale),K.matrixWorldInverse.copy(K.matrixWorld).invert(),De[10]===-1)K.projectionMatrix.copy(le.projectionMatrix),K.projectionMatrixInverse.copy(le.projectionMatrixInverse);else{const Oe=it+C,Ye=j+C,ue=Qe-rt,Pe=vt+(ye-rt),M=ge*j/Ye*Oe,d=fe*j/Ye*Oe;K.projectionMatrix.makePerspective(ue,Pe,M,d,Oe,Ye),K.projectionMatrixInverse.copy(K.projectionMatrix).invert()}}function ve(K,le){le===null?K.matrixWorld.copy(K.matrix):K.matrixWorld.multiplyMatrices(le.matrixWorld,K.matrix),K.matrixWorldInverse.copy(K.matrixWorld).invert()}this.updateCamera=function(K){if(r===null)return;let le=K.near,ie=K.far;p.texture!==null&&(p.depthNear>0&&(le=p.depthNear),p.depthFar>0&&(ie=p.depthFar)),F.near=L.near=A.near=le,F.far=L.far=A.far=ie,(W!==F.near||Y!==F.far)&&(r.updateRenderState({depthNear:F.near,depthFar:F.far}),W=F.near,Y=F.far),F.layers.mask=K.layers.mask|6,A.layers.mask=F.layers.mask&-5,L.layers.mask=F.layers.mask&-3;const ye=K.parent,De=F.cameras;ve(F,ye);for(let we=0;we<De.length;we++)ve(De[we],ye);De.length===2?oe(F,A,L):F.projectionMatrix.copy(A.projectionMatrix),Ee(K,F,ye)};function Ee(K,le,ie){ie===null?K.matrix.copy(le.matrixWorld):(K.matrix.copy(ie.matrixWorld),K.matrix.invert(),K.matrix.multiply(le.matrixWorld)),K.matrix.decompose(K.position,K.quaternion,K.scale),K.updateMatrixWorld(!0),K.projectionMatrix.copy(le.projectionMatrix),K.projectionMatrixInverse.copy(le.projectionMatrixInverse),K.isPerspectiveCamera&&(K.fov=sa*2*Math.atan(1/K.projectionMatrix.elements[5]),K.zoom=1)}this.getCamera=function(){return F},this.getFoveation=function(){if(!(u===null&&_===null))return c},this.setFoveation=function(K){c=K,u!==null&&(u.fixedFoveation=K),_!==null&&_.fixedFoveation!==void 0&&(_.fixedFoveation=K)},this.hasDepthSensing=function(){return p.texture!==null},this.getDepthSensingMesh=function(){return p.getMesh(F)},this.getCameraTexture=function(K){return h[K]};let ke=null;function Ve(K,le){if(f=le.getViewerPose(l||a),v=le,f!==null){const ie=f.views;_!==null&&(e.setRenderTargetFramebuffer(E,_.framebuffer),e.setRenderTarget(E));let ye=!1;ie.length!==F.cameras.length&&(F.cameras.length=0,ye=!0);for(let j=0;j<ie.length;j++){const ge=ie[j];let fe=null;if(_!==null)fe=_.getViewport(ge);else{const Fe=m.getViewSubImage(u,ge);fe=Fe.viewport,j===0&&(e.setRenderTargetTextures(E,Fe.colorTexture,Fe.depthStencilTexture),e.setRenderTarget(E))}let Te=w[j];Te===void 0&&(Te=new Vt,Te.layers.enable(j),Te.viewport=new ut,w[j]=Te),Te.matrix.fromArray(ge.transform.matrix),Te.matrix.decompose(Te.position,Te.quaternion,Te.scale),Te.projectionMatrix.fromArray(ge.projectionMatrix),Te.projectionMatrixInverse.copy(Te.projectionMatrix).invert(),Te.viewport.set(fe.x,fe.y,fe.width,fe.height),j===0&&(F.matrix.copy(Te.matrix),F.matrix.decompose(F.position,F.quaternion,F.scale)),ye===!0&&F.cameras.push(Te)}const De=r.enabledFeatures;if(De&&De.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&y){m=n.getBinding();const j=m.getDepthInformation(ie[0]);j&&j.isValid&&j.texture&&p.init(j,r.renderState)}if(De&&De.includes("camera-access")&&y){e.state.unbindTexture(),m=n.getBinding();for(let j=0;j<ie.length;j++){const ge=ie[j].camera;if(ge){let fe=h[ge];fe||(fe=new fl,h[ge]=fe);const Te=m.getCameraImage(ge);fe.sourceTexture=Te}}}}for(let ie=0;ie<R.length;ie++){const ye=b[ie],De=R[ie];ye!==null&&De!==void 0&&De.update(ye,le,l||a)}ke&&ke(K,le),le.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:le}),v=null}const Le=new _l;Le.setAnimationLoop(Ve),this.setAnimationLoop=function(K){ke=K},this.dispose=function(){}}}const jp=new ht,yl=new Ne;yl.set(-1,0,0,0,1,0,0,0,1);function Jp(i,e){function t(p,h){p.matrixAutoUpdate===!0&&p.updateMatrix(),h.value.copy(p.matrix)}function n(p,h){h.color.getRGB(p.fogColor.value,dl(i)),h.isFog?(p.fogNear.value=h.near,p.fogFar.value=h.far):h.isFogExp2&&(p.fogDensity.value=h.density)}function r(p,h,S,T,E){h.isNodeMaterial?h.uniformsNeedUpdate=!1:h.isMeshBasicMaterial?s(p,h):h.isMeshLambertMaterial?(s(p,h),h.envMap&&(p.envMapIntensity.value=h.envMapIntensity)):h.isMeshToonMaterial?(s(p,h),m(p,h)):h.isMeshPhongMaterial?(s(p,h),f(p,h),h.envMap&&(p.envMapIntensity.value=h.envMapIntensity)):h.isMeshStandardMaterial?(s(p,h),u(p,h),h.isMeshPhysicalMaterial&&_(p,h,E)):h.isMeshMatcapMaterial?(s(p,h),v(p,h)):h.isMeshDepthMaterial?s(p,h):h.isMeshDistanceMaterial?(s(p,h),y(p,h)):h.isMeshNormalMaterial?s(p,h):h.isLineBasicMaterial?(a(p,h),h.isLineDashedMaterial&&o(p,h)):h.isPointsMaterial?c(p,h,S,T):h.isSpriteMaterial?l(p,h):h.isShadowMaterial?(p.color.value.copy(h.color),p.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function s(p,h){p.opacity.value=h.opacity,h.color&&p.diffuse.value.copy(h.color),h.emissive&&p.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(p.map.value=h.map,t(h.map,p.mapTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,t(h.alphaMap,p.alphaMapTransform)),h.bumpMap&&(p.bumpMap.value=h.bumpMap,t(h.bumpMap,p.bumpMapTransform),p.bumpScale.value=h.bumpScale,h.side===Ct&&(p.bumpScale.value*=-1)),h.normalMap&&(p.normalMap.value=h.normalMap,t(h.normalMap,p.normalMapTransform),p.normalScale.value.copy(h.normalScale),h.side===Ct&&p.normalScale.value.negate()),h.displacementMap&&(p.displacementMap.value=h.displacementMap,t(h.displacementMap,p.displacementMapTransform),p.displacementScale.value=h.displacementScale,p.displacementBias.value=h.displacementBias),h.emissiveMap&&(p.emissiveMap.value=h.emissiveMap,t(h.emissiveMap,p.emissiveMapTransform)),h.specularMap&&(p.specularMap.value=h.specularMap,t(h.specularMap,p.specularMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest);const S=e.get(h),T=S.envMap,E=S.envMapRotation;T&&(p.envMap.value=T,p.envMapRotation.value.setFromMatrix4(jp.makeRotationFromEuler(E)).transpose(),T.isCubeTexture&&T.isRenderTargetTexture===!1&&p.envMapRotation.value.premultiply(yl),p.reflectivity.value=h.reflectivity,p.ior.value=h.ior,p.refractionRatio.value=h.refractionRatio),h.lightMap&&(p.lightMap.value=h.lightMap,p.lightMapIntensity.value=h.lightMapIntensity,t(h.lightMap,p.lightMapTransform)),h.aoMap&&(p.aoMap.value=h.aoMap,p.aoMapIntensity.value=h.aoMapIntensity,t(h.aoMap,p.aoMapTransform))}function a(p,h){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,h.map&&(p.map.value=h.map,t(h.map,p.mapTransform))}function o(p,h){p.dashSize.value=h.dashSize,p.totalSize.value=h.dashSize+h.gapSize,p.scale.value=h.scale}function c(p,h,S,T){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,p.size.value=h.size*S,p.scale.value=T*.5,h.map&&(p.map.value=h.map,t(h.map,p.uvTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,t(h.alphaMap,p.alphaMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest)}function l(p,h){p.diffuse.value.copy(h.color),p.opacity.value=h.opacity,p.rotation.value=h.rotation,h.map&&(p.map.value=h.map,t(h.map,p.mapTransform)),h.alphaMap&&(p.alphaMap.value=h.alphaMap,t(h.alphaMap,p.alphaMapTransform)),h.alphaTest>0&&(p.alphaTest.value=h.alphaTest)}function f(p,h){p.specular.value.copy(h.specular),p.shininess.value=Math.max(h.shininess,1e-4)}function m(p,h){h.gradientMap&&(p.gradientMap.value=h.gradientMap)}function u(p,h){p.metalness.value=h.metalness,h.metalnessMap&&(p.metalnessMap.value=h.metalnessMap,t(h.metalnessMap,p.metalnessMapTransform)),p.roughness.value=h.roughness,h.roughnessMap&&(p.roughnessMap.value=h.roughnessMap,t(h.roughnessMap,p.roughnessMapTransform)),h.envMap&&(p.envMapIntensity.value=h.envMapIntensity)}function _(p,h,S){p.ior.value=h.ior,h.sheen>0&&(p.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),p.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(p.sheenColorMap.value=h.sheenColorMap,t(h.sheenColorMap,p.sheenColorMapTransform)),h.sheenRoughnessMap&&(p.sheenRoughnessMap.value=h.sheenRoughnessMap,t(h.sheenRoughnessMap,p.sheenRoughnessMapTransform))),h.clearcoat>0&&(p.clearcoat.value=h.clearcoat,p.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(p.clearcoatMap.value=h.clearcoatMap,t(h.clearcoatMap,p.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,t(h.clearcoatRoughnessMap,p.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(p.clearcoatNormalMap.value=h.clearcoatNormalMap,t(h.clearcoatNormalMap,p.clearcoatNormalMapTransform),p.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===Ct&&p.clearcoatNormalScale.value.negate())),h.dispersion>0&&(p.dispersion.value=h.dispersion),h.iridescence>0&&(p.iridescence.value=h.iridescence,p.iridescenceIOR.value=h.iridescenceIOR,p.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(p.iridescenceMap.value=h.iridescenceMap,t(h.iridescenceMap,p.iridescenceMapTransform)),h.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=h.iridescenceThicknessMap,t(h.iridescenceThicknessMap,p.iridescenceThicknessMapTransform))),h.transmission>0&&(p.transmission.value=h.transmission,p.transmissionSamplerMap.value=S.texture,p.transmissionSamplerSize.value.set(S.width,S.height),h.transmissionMap&&(p.transmissionMap.value=h.transmissionMap,t(h.transmissionMap,p.transmissionMapTransform)),p.thickness.value=h.thickness,h.thicknessMap&&(p.thicknessMap.value=h.thicknessMap,t(h.thicknessMap,p.thicknessMapTransform)),p.attenuationDistance.value=h.attenuationDistance,p.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(p.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(p.anisotropyMap.value=h.anisotropyMap,t(h.anisotropyMap,p.anisotropyMapTransform))),p.specularIntensity.value=h.specularIntensity,p.specularColor.value.copy(h.specularColor),h.specularColorMap&&(p.specularColorMap.value=h.specularColorMap,t(h.specularColorMap,p.specularColorMapTransform)),h.specularIntensityMap&&(p.specularIntensityMap.value=h.specularIntensityMap,t(h.specularIntensityMap,p.specularIntensityMapTransform))}function v(p,h){h.matcap&&(p.matcap.value=h.matcap)}function y(p,h){const S=e.get(h).light;p.referencePosition.value.setFromMatrixPosition(S.matrixWorld),p.nearDistance.value=S.shadow.camera.near,p.farDistance.value=S.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:r}}function Qp(i,e,t,n){let r={},s={},a=[];const o=i.getParameter(i.MAX_UNIFORM_BUFFER_BINDINGS);function c(S,T){const E=T.program;n.uniformBlockBinding(S,E)}function l(S,T){let E=r[S.id];E===void 0&&(v(S),E=f(S),r[S.id]=E,S.addEventListener("dispose",p));const R=T.program;n.updateUBOMapping(S,R);const b=e.render.frame;s[S.id]!==b&&(u(S),s[S.id]=b)}function f(S){const T=m();S.__bindingPointIndex=T;const E=i.createBuffer(),R=S.__size,b=S.usage;return i.bindBuffer(i.UNIFORM_BUFFER,E),i.bufferData(i.UNIFORM_BUFFER,R,b),i.bindBuffer(i.UNIFORM_BUFFER,null),i.bindBufferBase(i.UNIFORM_BUFFER,T,E),E}function m(){for(let S=0;S<o;S++)if(a.indexOf(S)===-1)return a.push(S),S;return $e("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function u(S){const T=r[S.id],E=S.uniforms,R=S.__cache;i.bindBuffer(i.UNIFORM_BUFFER,T);for(let b=0,D=E.length;b<D;b++){const g=Array.isArray(E[b])?E[b]:[E[b]];for(let A=0,L=g.length;A<L;A++){const w=g[A];if(_(w,b,A,R)===!0){const F=w.__offset,W=Array.isArray(w.value)?w.value:[w.value];let Y=0;for(let N=0;N<W.length;N++){const B=W[N],V=y(B);typeof B=="number"||typeof B=="boolean"?(w.__data[0]=B,i.bufferSubData(i.UNIFORM_BUFFER,F+Y,w.__data)):B.isMatrix3?(w.__data[0]=B.elements[0],w.__data[1]=B.elements[1],w.__data[2]=B.elements[2],w.__data[3]=0,w.__data[4]=B.elements[3],w.__data[5]=B.elements[4],w.__data[6]=B.elements[5],w.__data[7]=0,w.__data[8]=B.elements[6],w.__data[9]=B.elements[7],w.__data[10]=B.elements[8],w.__data[11]=0):ArrayBuffer.isView(B)?w.__data.set(new B.constructor(B.buffer,B.byteOffset,w.__data.length)):(B.toArray(w.__data,Y),Y+=V.storage/Float32Array.BYTES_PER_ELEMENT)}i.bufferSubData(i.UNIFORM_BUFFER,F,w.__data)}}}i.bindBuffer(i.UNIFORM_BUFFER,null)}function _(S,T,E,R){const b=S.value,D=T+"_"+E;if(R[D]===void 0)return typeof b=="number"||typeof b=="boolean"?R[D]=b:ArrayBuffer.isView(b)?R[D]=b.slice():R[D]=b.clone(),!0;{const g=R[D];if(typeof b=="number"||typeof b=="boolean"){if(g!==b)return R[D]=b,!0}else{if(ArrayBuffer.isView(b))return!0;if(g.equals(b)===!1)return g.copy(b),!0}}return!1}function v(S){const T=S.uniforms;let E=0;const R=16;for(let D=0,g=T.length;D<g;D++){const A=Array.isArray(T[D])?T[D]:[T[D]];for(let L=0,w=A.length;L<w;L++){const F=A[L],W=Array.isArray(F.value)?F.value:[F.value];for(let Y=0,N=W.length;Y<N;Y++){const B=W[Y],V=y(B),J=E%R,ne=J%V.boundary,oe=J+ne;E+=ne,oe!==0&&R-oe<V.storage&&(E+=R-oe),F.__data=new Float32Array(V.storage/Float32Array.BYTES_PER_ELEMENT),F.__offset=E,E+=V.storage}}}const b=E%R;return b>0&&(E+=R-b),S.__size=E,S.__cache={},this}function y(S){const T={boundary:0,storage:0};return typeof S=="number"||typeof S=="boolean"?(T.boundary=4,T.storage=4):S.isVector2?(T.boundary=8,T.storage=8):S.isVector3||S.isColor?(T.boundary=16,T.storage=12):S.isVector4?(T.boundary=16,T.storage=16):S.isMatrix3?(T.boundary=48,T.storage=48):S.isMatrix4?(T.boundary=64,T.storage=64):S.isTexture?Ie("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(S)?(T.boundary=16,T.storage=S.byteLength):Ie("WebGLRenderer: Unsupported uniform value type.",S),T}function p(S){const T=S.target;T.removeEventListener("dispose",p);const E=a.indexOf(T.__bindingPointIndex);a.splice(E,1),i.deleteBuffer(r[T.id]),delete r[T.id],delete s[T.id]}function h(){for(const S in r)i.deleteBuffer(r[S]);a=[],r={},s={}}return{bind:c,update:l,dispose:h}}const em=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let Zt=null;function tm(){return Zt===null&&(Zt=new Hc(em,16,16,Kn,vn),Zt.name="DFG_LUT",Zt.minFilter=At,Zt.magFilter=At,Zt.wrapS=_n,Zt.wrapT=_n,Zt.generateMipmaps=!1,Zt.needsUpdate=!0),Zt}class nm{constructor(e={}){const{canvas:t=vc(),context:n=null,depth:r=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:f="default",failIfMajorPerformanceCaveat:m=!1,reversedDepthBuffer:u=!1,outputBufferType:_=Ot}=e;this.isWebGLRenderer=!0;let v;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");v=n.getContextAttributes().alpha}else v=a;const y=_,p=new Set([_a,ma,pa]),h=new Set([Ot,rn,Fi,Oi,fa,da]),S=new Uint32Array(4),T=new Int32Array(4),E=new O;let R=null,b=null;const D=[],g=[];let A=null;this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=en,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const L=this;let w=!1,F=null;this._outputColorSpace=Ft;let W=0,Y=0,N=null,B=-1,V=null;const J=new ut,ne=new ut;let oe=null;const ve=new Ze(0);let Ee=0,ke=t.width,Ve=t.height,Le=1,K=null,le=null;const ie=new ut(0,0,ke,Ve),ye=new ut(0,0,ke,Ve);let De=!1;const we=new Ea;let it=!1,j=!1;const ge=new ht,fe=new O,Te=new ut,Fe={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Qe=!1;function vt(){return N===null?Le:1}let C=n;function rt(x,U){return t.getContext(x,U)}try{const x={alpha:!0,depth:r,stencil:s,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:f,failIfMajorPerformanceCaveat:m};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${ca}`),t.addEventListener("webglcontextlost",te,!1),t.addEventListener("webglcontextrestored",Ae,!1),t.addEventListener("webglcontextcreationerror",Be,!1),C===null){const U="webgl2";if(C=rt(U,x),C===null)throw rt(U)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(x){throw $e("WebGLRenderer: "+x.message),x}let Oe,Ye,ue,Pe,M,d,I,q,Z,ee,Q,k,X,he,_e,re,se,Ue,Ge,Je,P,ae,$;function xe(){Oe=new td(C),Oe.init(),P=new qp(C,Oe),Ye=new Yf(C,Oe,e,P),ue=new Wp(C,Oe),Ye.reversedDepthBuffer&&u&&ue.buffers.depth.setReversed(!0),Pe=new rd(C),M=new Pp,d=new Xp(C,Oe,ue,M,Ye,P,Pe),I=new ed(L),q=new ou(C),ae=new Xf(C,q),Z=new nd(C,q,Pe,ae),ee=new ad(C,Z,q,ae,Pe),Ue=new sd(C,Ye,d),_e=new $f(M),Q=new Cp(L,I,Oe,Ye,ae,_e),k=new Jp(L,M),X=new Lp,he=new Bp(Oe),se=new Wf(L,I,ue,ee,v,c),re=new kp(L,ee,Ye),$=new Qp(C,Pe,Ye,ue),Ge=new qf(C,Oe,Pe),Je=new id(C,Oe,Pe),Pe.programs=Q.programs,L.capabilities=Ye,L.extensions=Oe,L.properties=M,L.renderLists=X,L.shadowMap=re,L.state=ue,L.info=Pe}xe(),y!==Ot&&(A=new ld(y,t.width,t.height,r,s));const ce=new Zp(L,C);this.xr=ce,this.getContext=function(){return C},this.getContextAttributes=function(){return C.getContextAttributes()},this.forceContextLoss=function(){const x=Oe.get("WEBGL_lose_context");x&&x.loseContext()},this.forceContextRestore=function(){const x=Oe.get("WEBGL_lose_context");x&&x.restoreContext()},this.getPixelRatio=function(){return Le},this.setPixelRatio=function(x){x!==void 0&&(Le=x,this.setSize(ke,Ve,!1))},this.getSize=function(x){return x.set(ke,Ve)},this.setSize=function(x,U,H=!0){if(ce.isPresenting){Ie("WebGLRenderer: Can't change size while VR device is presenting.");return}ke=x,Ve=U,t.width=Math.floor(x*Le),t.height=Math.floor(U*Le),H===!0&&(t.style.width=x+"px",t.style.height=U+"px"),A!==null&&A.setSize(t.width,t.height),this.setViewport(0,0,x,U)},this.getDrawingBufferSize=function(x){return x.set(ke*Le,Ve*Le).floor()},this.setDrawingBufferSize=function(x,U,H){ke=x,Ve=U,Le=H,t.width=Math.floor(x*H),t.height=Math.floor(U*H),this.setViewport(0,0,x,U)},this.setEffects=function(x){if(y===Ot){$e("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(x){for(let U=0;U<x.length;U++)if(x[U].isOutputPass===!0){Ie("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}A.setEffects(x||[])},this.getCurrentViewport=function(x){return x.copy(J)},this.getViewport=function(x){return x.copy(ie)},this.setViewport=function(x,U,H,z){x.isVector4?ie.set(x.x,x.y,x.z,x.w):ie.set(x,U,H,z),ue.viewport(J.copy(ie).multiplyScalar(Le).round())},this.getScissor=function(x){return x.copy(ye)},this.setScissor=function(x,U,H,z){x.isVector4?ye.set(x.x,x.y,x.z,x.w):ye.set(x,U,H,z),ue.scissor(ne.copy(ye).multiplyScalar(Le).round())},this.getScissorTest=function(){return De},this.setScissorTest=function(x){ue.setScissorTest(De=x)},this.setOpaqueSort=function(x){K=x},this.setTransparentSort=function(x){le=x},this.getClearColor=function(x){return x.copy(se.getClearColor())},this.setClearColor=function(){se.setClearColor(...arguments)},this.getClearAlpha=function(){return se.getClearAlpha()},this.setClearAlpha=function(){se.setClearAlpha(...arguments)},this.clear=function(x=!0,U=!0,H=!0){let z=0;if(x){let G=!1;if(N!==null){const me=N.texture.format;G=p.has(me)}if(G){const me=N.texture.type,Se=h.has(me),pe=se.getClearColor(),be=se.getClearAlpha(),Re=pe.r,ze=pe.g,We=pe.b;Se?(S[0]=Re,S[1]=ze,S[2]=We,S[3]=be,C.clearBufferuiv(C.COLOR,0,S)):(T[0]=Re,T[1]=ze,T[2]=We,T[3]=be,C.clearBufferiv(C.COLOR,0,T))}else z|=C.COLOR_BUFFER_BIT}U&&(z|=C.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),H&&(z|=C.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),z!==0&&C.clear(z)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(x){x.setRenderer(this),F=x},this.dispose=function(){t.removeEventListener("webglcontextlost",te,!1),t.removeEventListener("webglcontextrestored",Ae,!1),t.removeEventListener("webglcontextcreationerror",Be,!1),se.dispose(),X.dispose(),he.dispose(),M.dispose(),I.dispose(),ee.dispose(),ae.dispose(),$.dispose(),Q.dispose(),ce.dispose(),ce.removeEventListener("sessionstart",Pa),ce.removeEventListener("sessionend",Da),Nn.stop()};function te(x){x.preventDefault(),Za("WebGLRenderer: Context Lost."),w=!0}function Ae(){Za("WebGLRenderer: Context Restored."),w=!1;const x=Pe.autoReset,U=re.enabled,H=re.autoUpdate,z=re.needsUpdate,G=re.type;xe(),Pe.autoReset=x,re.enabled=U,re.autoUpdate=H,re.needsUpdate=z,re.type=G}function Be(x){$e("WebGLRenderer: A WebGL context could not be created. Reason: ",x.statusMessage)}function ft(x){const U=x.target;U.removeEventListener("dispose",ft),tt(U)}function tt(x){an(x),M.remove(x)}function an(x){const U=M.get(x).programs;U!==void 0&&(U.forEach(function(H){Q.releaseProgram(H)}),x.isShaderMaterial&&Q.releaseShaderCache(x))}this.renderBufferDirect=function(x,U,H,z,G,me){U===null&&(U=Fe);const Se=G.isMesh&&G.matrixWorld.determinant()<0,pe=wl(x,U,H,z,G);ue.setMaterial(z,Se);let be=H.index,Re=1;if(z.wireframe===!0){if(be=Z.getWireframeAttribute(H),be===void 0)return;Re=2}const ze=H.drawRange,We=H.attributes.position;let Ce=ze.start*Re,nt=(ze.start+ze.count)*Re;me!==null&&(Ce=Math.max(Ce,me.start*Re),nt=Math.min(nt,(me.start+me.count)*Re)),be!==null?(Ce=Math.max(Ce,0),nt=Math.min(nt,be.count)):We!=null&&(Ce=Math.max(Ce,0),nt=Math.min(nt,We.count));const dt=nt-Ce;if(dt<0||dt===1/0)return;ae.setup(G,z,pe,H,be);let ct,st=Ge;if(be!==null&&(ct=q.get(be),st=Je,st.setIndex(ct)),G.isMesh)z.wireframe===!0?(ue.setLineWidth(z.wireframeLinewidth*vt()),st.setMode(C.LINES)):st.setMode(C.TRIANGLES);else if(G.isLine){let yt=z.linewidth;yt===void 0&&(yt=1),ue.setLineWidth(yt*vt()),G.isLineSegments?st.setMode(C.LINES):G.isLineLoop?st.setMode(C.LINE_LOOP):st.setMode(C.LINE_STRIP)}else G.isPoints?st.setMode(C.POINTS):G.isSprite&&st.setMode(C.TRIANGLES);if(G.isBatchedMesh)if(Oe.get("WEBGL_multi_draw"))st.renderMultiDraw(G._multiDrawStarts,G._multiDrawCounts,G._multiDrawCount);else{const yt=G._multiDrawStarts,Me=G._multiDrawCounts,It=G._multiDrawCount,Ke=be?q.get(be).bytesPerElement:1,zt=M.get(z).currentProgram.getUniforms();for(let $t=0;$t<It;$t++)zt.setValue(C,"_gl_DrawID",$t),st.render(yt[$t]/Ke,Me[$t])}else if(G.isInstancedMesh)st.renderInstances(Ce,dt,G.count);else if(H.isInstancedBufferGeometry){const yt=H._maxInstanceCount!==void 0?H._maxInstanceCount:1/0,Me=Math.min(H.instanceCount,yt);st.renderInstances(Ce,dt,Me)}else st.render(Ce,dt)};function Yt(x,U,H){x.transparent===!0&&x.side===pn&&x.forceSinglePass===!1?(x.side=Ct,x.needsUpdate=!0,Wi(x,U,H),x.side=In,x.needsUpdate=!0,Wi(x,U,H),x.side=pn):Wi(x,U,H)}this.compile=function(x,U,H=null){H===null&&(H=x),b=he.get(H),b.init(U),g.push(b),H.traverseVisible(function(G){G.isLight&&G.layers.test(U.layers)&&(b.pushLight(G),G.castShadow&&b.pushShadow(G))}),x!==H&&x.traverseVisible(function(G){G.isLight&&G.layers.test(U.layers)&&(b.pushLight(G),G.castShadow&&b.pushShadow(G))}),b.setupLights();const z=new Set;return x.traverse(function(G){if(!(G.isMesh||G.isPoints||G.isLine||G.isSprite))return;const me=G.material;if(me)if(Array.isArray(me))for(let Se=0;Se<me.length;Se++){const pe=me[Se];Yt(pe,H,G),z.add(pe)}else Yt(me,H,G),z.add(me)}),b=g.pop(),z},this.compileAsync=function(x,U,H=null){const z=this.compile(x,U,H);return new Promise(G=>{function me(){if(z.forEach(function(Se){M.get(Se).currentProgram.isReady()&&z.delete(Se)}),z.size===0){G(x);return}setTimeout(me,10)}Oe.get("KHR_parallel_shader_compile")!==null?me():setTimeout(me,10)})};let Lr=null;function Tl(x){Lr&&Lr(x)}function Pa(){Nn.stop()}function Da(){Nn.start()}const Nn=new _l;Nn.setAnimationLoop(Tl),typeof self<"u"&&Nn.setContext(self),this.setAnimationLoop=function(x){Lr=x,ce.setAnimationLoop(x),x===null?Nn.stop():Nn.start()},ce.addEventListener("sessionstart",Pa),ce.addEventListener("sessionend",Da),this.render=function(x,U){if(U!==void 0&&U.isCamera!==!0){$e("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(w===!0)return;F!==null&&F.renderStart(x,U);const H=ce.enabled===!0&&ce.isPresenting===!0,z=A!==null&&(N===null||H)&&A.begin(L,N);if(x.matrixWorldAutoUpdate===!0&&x.updateMatrixWorld(),U.parent===null&&U.matrixWorldAutoUpdate===!0&&U.updateMatrixWorld(),ce.enabled===!0&&ce.isPresenting===!0&&(A===null||A.isCompositing()===!1)&&(ce.cameraAutoUpdate===!0&&ce.updateCamera(U),U=ce.getCamera()),x.isScene===!0&&x.onBeforeRender(L,x,U,N),b=he.get(x,g.length),b.init(U),b.state.textureUnits=d.getTextureUnits(),g.push(b),ge.multiplyMatrices(U.projectionMatrix,U.matrixWorldInverse),we.setFromProjectionMatrix(ge,Qt,U.reversedDepth),j=this.localClippingEnabled,it=_e.init(this.clippingPlanes,j),R=X.get(x,D.length),R.init(),D.push(R),ce.enabled===!0&&ce.isPresenting===!0){const Se=L.xr.getDepthSensingMesh();Se!==null&&Ir(Se,U,-1/0,L.sortObjects)}Ir(x,U,0,L.sortObjects),R.finish(),L.sortObjects===!0&&R.sort(K,le),Qe=ce.enabled===!1||ce.isPresenting===!1||ce.hasDepthSensing()===!1,Qe&&se.addToRenderList(R,x),this.info.render.frame++,it===!0&&_e.beginShadows();const G=b.state.shadowsArray;if(re.render(G,x,U),it===!0&&_e.endShadows(),this.info.autoReset===!0&&this.info.reset(),(z&&A.hasRenderPass())===!1){const Se=R.opaque,pe=R.transmissive;if(b.setupLights(),U.isArrayCamera){const be=U.cameras;if(pe.length>0)for(let Re=0,ze=be.length;Re<ze;Re++){const We=be[Re];Ia(Se,pe,x,We)}Qe&&se.render(x);for(let Re=0,ze=be.length;Re<ze;Re++){const We=be[Re];La(R,x,We,We.viewport)}}else pe.length>0&&Ia(Se,pe,x,U),Qe&&se.render(x),La(R,x,U)}N!==null&&Y===0&&(d.updateMultisampleRenderTarget(N),d.updateRenderTargetMipmap(N)),z&&A.end(L),x.isScene===!0&&x.onAfterRender(L,x,U),ae.resetDefaultState(),B=-1,V=null,g.pop(),g.length>0?(b=g[g.length-1],d.setTextureUnits(b.state.textureUnits),it===!0&&_e.setGlobalState(L.clippingPlanes,b.state.camera)):b=null,D.pop(),D.length>0?R=D[D.length-1]:R=null,F!==null&&F.renderEnd()};function Ir(x,U,H,z){if(x.visible===!1)return;if(x.layers.test(U.layers)){if(x.isGroup)H=x.renderOrder;else if(x.isLOD)x.autoUpdate===!0&&x.update(U);else if(x.isLightProbeGrid)b.pushLightProbeGrid(x);else if(x.isLight)b.pushLight(x),x.castShadow&&b.pushShadow(x);else if(x.isSprite){if(!x.frustumCulled||we.intersectsSprite(x)){z&&Te.setFromMatrixPosition(x.matrixWorld).applyMatrix4(ge);const Se=ee.update(x),pe=x.material;pe.visible&&R.push(x,Se,pe,H,Te.z,null)}}else if((x.isMesh||x.isLine||x.isPoints)&&(!x.frustumCulled||we.intersectsObject(x))){const Se=ee.update(x),pe=x.material;if(z&&(x.boundingSphere!==void 0?(x.boundingSphere===null&&x.computeBoundingSphere(),Te.copy(x.boundingSphere.center)):(Se.boundingSphere===null&&Se.computeBoundingSphere(),Te.copy(Se.boundingSphere.center)),Te.applyMatrix4(x.matrixWorld).applyMatrix4(ge)),Array.isArray(pe)){const be=Se.groups;for(let Re=0,ze=be.length;Re<ze;Re++){const We=be[Re],Ce=pe[We.materialIndex];Ce&&Ce.visible&&R.push(x,Se,Ce,H,Te.z,We)}}else pe.visible&&R.push(x,Se,pe,H,Te.z,null)}}const me=x.children;for(let Se=0,pe=me.length;Se<pe;Se++)Ir(me[Se],U,H,z)}function La(x,U,H,z){const{opaque:G,transmissive:me,transparent:Se}=x;b.setupLightsView(H),it===!0&&_e.setGlobalState(L.clippingPlanes,H),z&&ue.viewport(J.copy(z)),G.length>0&&ki(G,U,H),me.length>0&&ki(me,U,H),Se.length>0&&ki(Se,U,H),ue.buffers.depth.setTest(!0),ue.buffers.depth.setMask(!0),ue.buffers.color.setMask(!0),ue.setPolygonOffset(!1)}function Ia(x,U,H,z){if((H.isScene===!0?H.overrideMaterial:null)!==null)return;if(b.state.transmissionRenderTarget[z.id]===void 0){const Ce=Oe.has("EXT_color_buffer_half_float")||Oe.has("EXT_color_buffer_float");b.state.transmissionRenderTarget[z.id]=new tn(1,1,{generateMipmaps:!0,type:Ce?vn:Ot,minFilter:qn,samples:Math.max(4,Ye.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Xe.workingColorSpace})}const me=b.state.transmissionRenderTarget[z.id],Se=z.viewport||J;me.setSize(Se.z*L.transmissionResolutionScale,Se.w*L.transmissionResolutionScale);const pe=L.getRenderTarget(),be=L.getActiveCubeFace(),Re=L.getActiveMipmapLevel();L.setRenderTarget(me),L.getClearColor(ve),Ee=L.getClearAlpha(),Ee<1&&L.setClearColor(16777215,.5),L.clear(),Qe&&se.render(H);const ze=L.toneMapping;L.toneMapping=en;const We=z.viewport;if(z.viewport!==void 0&&(z.viewport=void 0),b.setupLightsView(z),it===!0&&_e.setGlobalState(L.clippingPlanes,z),ki(x,H,z),d.updateMultisampleRenderTarget(me),d.updateRenderTargetMipmap(me),Oe.has("WEBGL_multisampled_render_to_texture")===!1){let Ce=!1;for(let nt=0,dt=U.length;nt<dt;nt++){const ct=U[nt],{object:st,geometry:yt,material:Me,group:It}=ct;if(Me.side===pn&&st.layers.test(z.layers)){const Ke=Me.side;Me.side=Ct,Me.needsUpdate=!0,Ua(st,H,z,yt,Me,It),Me.side=Ke,Me.needsUpdate=!0,Ce=!0}}Ce===!0&&(d.updateMultisampleRenderTarget(me),d.updateRenderTargetMipmap(me))}L.setRenderTarget(pe,be,Re),L.setClearColor(ve,Ee),We!==void 0&&(z.viewport=We),L.toneMapping=ze}function ki(x,U,H){const z=U.isScene===!0?U.overrideMaterial:null;for(let G=0,me=x.length;G<me;G++){const Se=x[G],{object:pe,geometry:be,group:Re}=Se;let ze=Se.material;ze.allowOverride===!0&&z!==null&&(ze=z),pe.layers.test(H.layers)&&Ua(pe,U,H,be,ze,Re)}}function Ua(x,U,H,z,G,me){x.onBeforeRender(L,U,H,z,G,me),x.modelViewMatrix.multiplyMatrices(H.matrixWorldInverse,x.matrixWorld),x.normalMatrix.getNormalMatrix(x.modelViewMatrix),G.onBeforeRender(L,U,H,z,x,me),G.transparent===!0&&G.side===pn&&G.forceSinglePass===!1?(G.side=Ct,G.needsUpdate=!0,L.renderBufferDirect(H,U,z,G,x,me),G.side=In,G.needsUpdate=!0,L.renderBufferDirect(H,U,z,G,x,me),G.side=pn):L.renderBufferDirect(H,U,z,G,x,me),x.onAfterRender(L,U,H,z,G,me)}function Wi(x,U,H){U.isScene!==!0&&(U=Fe);const z=M.get(x),G=b.state.lights,me=b.state.shadowsArray,Se=G.state.version,pe=Q.getParameters(x,G.state,me,U,H,b.state.lightProbeGridArray),be=Q.getProgramCacheKey(pe);let Re=z.programs;z.environment=x.isMeshStandardMaterial||x.isMeshLambertMaterial||x.isMeshPhongMaterial?U.environment:null,z.fog=U.fog;const ze=x.isMeshStandardMaterial||x.isMeshLambertMaterial&&!x.envMap||x.isMeshPhongMaterial&&!x.envMap;z.envMap=I.get(x.envMap||z.environment,ze),z.envMapRotation=z.environment!==null&&x.envMap===null?U.environmentRotation:x.envMapRotation,Re===void 0&&(x.addEventListener("dispose",ft),Re=new Map,z.programs=Re);let We=Re.get(be);if(We!==void 0){if(z.currentProgram===We&&z.lightsStateVersion===Se)return Fa(x,pe),We}else pe.uniforms=Q.getUniforms(x),F!==null&&x.isNodeMaterial&&F.build(x,H,pe),x.onBeforeCompile(pe,L),We=Q.acquireProgram(pe,be),Re.set(be,We),z.uniforms=pe.uniforms;const Ce=z.uniforms;return(!x.isShaderMaterial&&!x.isRawShaderMaterial||x.clipping===!0)&&(Ce.clippingPlanes=_e.uniform),Fa(x,pe),z.needsLights=Cl(x),z.lightsStateVersion=Se,z.needsLights&&(Ce.ambientLightColor.value=G.state.ambient,Ce.lightProbe.value=G.state.probe,Ce.directionalLights.value=G.state.directional,Ce.directionalLightShadows.value=G.state.directionalShadow,Ce.spotLights.value=G.state.spot,Ce.spotLightShadows.value=G.state.spotShadow,Ce.rectAreaLights.value=G.state.rectArea,Ce.ltc_1.value=G.state.rectAreaLTC1,Ce.ltc_2.value=G.state.rectAreaLTC2,Ce.pointLights.value=G.state.point,Ce.pointLightShadows.value=G.state.pointShadow,Ce.hemisphereLights.value=G.state.hemi,Ce.directionalShadowMatrix.value=G.state.directionalShadowMatrix,Ce.spotLightMatrix.value=G.state.spotLightMatrix,Ce.spotLightMap.value=G.state.spotLightMap,Ce.pointShadowMatrix.value=G.state.pointShadowMatrix),z.lightProbeGrid=b.state.lightProbeGridArray.length>0,z.currentProgram=We,z.uniformsList=null,We}function Na(x){if(x.uniformsList===null){const U=x.currentProgram.getUniforms();x.uniformsList=Mr.seqWithValue(U.seq,x.uniforms)}return x.uniformsList}function Fa(x,U){const H=M.get(x);H.outputColorSpace=U.outputColorSpace,H.batching=U.batching,H.batchingColor=U.batchingColor,H.instancing=U.instancing,H.instancingColor=U.instancingColor,H.instancingMorph=U.instancingMorph,H.skinning=U.skinning,H.morphTargets=U.morphTargets,H.morphNormals=U.morphNormals,H.morphColors=U.morphColors,H.morphTargetsCount=U.morphTargetsCount,H.numClippingPlanes=U.numClippingPlanes,H.numIntersection=U.numClipIntersection,H.vertexAlphas=U.vertexAlphas,H.vertexTangents=U.vertexTangents,H.toneMapping=U.toneMapping}function Al(x,U){if(x.length===0)return null;if(x.length===1)return x[0].texture!==null?x[0]:null;E.setFromMatrixPosition(U.matrixWorld);for(let H=0,z=x.length;H<z;H++){const G=x[H];if(G.texture!==null&&G.boundingBox.containsPoint(E))return G}return null}function wl(x,U,H,z,G){U.isScene!==!0&&(U=Fe),d.resetTextureUnits();const me=U.fog,Se=z.isMeshStandardMaterial||z.isMeshLambertMaterial||z.isMeshPhongMaterial?U.environment:null,pe=N===null?L.outputColorSpace:N.isXRRenderTarget===!0?N.texture.colorSpace:Xe.workingColorSpace,be=z.isMeshStandardMaterial||z.isMeshLambertMaterial&&!z.envMap||z.isMeshPhongMaterial&&!z.envMap,Re=I.get(z.envMap||Se,be),ze=z.vertexColors===!0&&!!H.attributes.color&&H.attributes.color.itemSize===4,We=!!H.attributes.tangent&&(!!z.normalMap||z.anisotropy>0),Ce=!!H.morphAttributes.position,nt=!!H.morphAttributes.normal,dt=!!H.morphAttributes.color;let ct=en;z.toneMapped&&(N===null||N.isXRRenderTarget===!0)&&(ct=L.toneMapping);const st=H.morphAttributes.position||H.morphAttributes.normal||H.morphAttributes.color,yt=st!==void 0?st.length:0,Me=M.get(z),It=b.state.lights;if(it===!0&&(j===!0||x!==V)){const ot=x===V&&z.id===B;_e.setState(z,x,ot)}let Ke=!1;z.version===Me.__version?(Me.needsLights&&Me.lightsStateVersion!==It.state.version||Me.outputColorSpace!==pe||G.isBatchedMesh&&Me.batching===!1||!G.isBatchedMesh&&Me.batching===!0||G.isBatchedMesh&&Me.batchingColor===!0&&G.colorTexture===null||G.isBatchedMesh&&Me.batchingColor===!1&&G.colorTexture!==null||G.isInstancedMesh&&Me.instancing===!1||!G.isInstancedMesh&&Me.instancing===!0||G.isSkinnedMesh&&Me.skinning===!1||!G.isSkinnedMesh&&Me.skinning===!0||G.isInstancedMesh&&Me.instancingColor===!0&&G.instanceColor===null||G.isInstancedMesh&&Me.instancingColor===!1&&G.instanceColor!==null||G.isInstancedMesh&&Me.instancingMorph===!0&&G.morphTexture===null||G.isInstancedMesh&&Me.instancingMorph===!1&&G.morphTexture!==null||Me.envMap!==Re||z.fog===!0&&Me.fog!==me||Me.numClippingPlanes!==void 0&&(Me.numClippingPlanes!==_e.numPlanes||Me.numIntersection!==_e.numIntersection)||Me.vertexAlphas!==ze||Me.vertexTangents!==We||Me.morphTargets!==Ce||Me.morphNormals!==nt||Me.morphColors!==dt||Me.toneMapping!==ct||Me.morphTargetsCount!==yt||!!Me.lightProbeGrid!=b.state.lightProbeGridArray.length>0)&&(Ke=!0):(Ke=!0,Me.__version=z.version);let zt=Me.currentProgram;Ke===!0&&(zt=Wi(z,U,G),F&&z.isNodeMaterial&&F.onUpdateProgram(z,zt,Me));let $t=!1,Sn=!1,Jn=!1;const at=zt.getUniforms(),pt=Me.uniforms;if(ue.useProgram(zt.program)&&($t=!0,Sn=!0,Jn=!0),z.id!==B&&(B=z.id,Sn=!0),Me.needsLights){const ot=Al(b.state.lightProbeGridArray,G);Me.lightProbeGrid!==ot&&(Me.lightProbeGrid=ot,Sn=!0)}if($t||V!==x){ue.buffers.depth.getReversed()&&x.reversedDepth!==!0&&(x._reversedDepth=!0,x.updateProjectionMatrix()),at.setValue(C,"projectionMatrix",x.projectionMatrix),at.setValue(C,"viewMatrix",x.matrixWorldInverse);const yn=at.map.cameraPosition;yn!==void 0&&yn.setValue(C,fe.setFromMatrixPosition(x.matrixWorld)),Ye.logarithmicDepthBuffer&&at.setValue(C,"logDepthBufFC",2/(Math.log(x.far+1)/Math.LN2)),(z.isMeshPhongMaterial||z.isMeshToonMaterial||z.isMeshLambertMaterial||z.isMeshBasicMaterial||z.isMeshStandardMaterial||z.isShaderMaterial)&&at.setValue(C,"isOrthographic",x.isOrthographicCamera===!0),V!==x&&(V=x,Sn=!0,Jn=!0)}if(Me.needsLights&&(It.state.directionalShadowMap.length>0&&at.setValue(C,"directionalShadowMap",It.state.directionalShadowMap,d),It.state.spotShadowMap.length>0&&at.setValue(C,"spotShadowMap",It.state.spotShadowMap,d),It.state.pointShadowMap.length>0&&at.setValue(C,"pointShadowMap",It.state.pointShadowMap,d)),G.isSkinnedMesh){at.setOptional(C,G,"bindMatrix"),at.setOptional(C,G,"bindMatrixInverse");const ot=G.skeleton;ot&&(ot.boneTexture===null&&ot.computeBoneTexture(),at.setValue(C,"boneTexture",ot.boneTexture,d))}G.isBatchedMesh&&(at.setOptional(C,G,"batchingTexture"),at.setValue(C,"batchingTexture",G._matricesTexture,d),at.setOptional(C,G,"batchingIdTexture"),at.setValue(C,"batchingIdTexture",G._indirectTexture,d),at.setOptional(C,G,"batchingColorTexture"),G._colorsTexture!==null&&at.setValue(C,"batchingColorTexture",G._colorsTexture,d));const En=H.morphAttributes;if((En.position!==void 0||En.normal!==void 0||En.color!==void 0)&&Ue.update(G,H,zt),(Sn||Me.receiveShadow!==G.receiveShadow)&&(Me.receiveShadow=G.receiveShadow,at.setValue(C,"receiveShadow",G.receiveShadow)),(z.isMeshStandardMaterial||z.isMeshLambertMaterial||z.isMeshPhongMaterial)&&z.envMap===null&&U.environment!==null&&(pt.envMapIntensity.value=U.environmentIntensity),pt.dfgLUT!==void 0&&(pt.dfgLUT.value=tm()),Sn){if(at.setValue(C,"toneMappingExposure",L.toneMappingExposure),Me.needsLights&&Rl(pt,Jn),me&&z.fog===!0&&k.refreshFogUniforms(pt,me),k.refreshMaterialUniforms(pt,z,Le,Ve,b.state.transmissionRenderTarget[x.id]),Me.needsLights&&Me.lightProbeGrid){const ot=Me.lightProbeGrid;pt.probesSH.value=ot.texture,pt.probesMin.value.copy(ot.boundingBox.min),pt.probesMax.value.copy(ot.boundingBox.max),pt.probesResolution.value.copy(ot.resolution)}Mr.upload(C,Na(Me),pt,d)}if(z.isShaderMaterial&&z.uniformsNeedUpdate===!0&&(Mr.upload(C,Na(Me),pt,d),z.uniformsNeedUpdate=!1),z.isSpriteMaterial&&at.setValue(C,"center",G.center),at.setValue(C,"modelViewMatrix",G.modelViewMatrix),at.setValue(C,"normalMatrix",G.normalMatrix),at.setValue(C,"modelMatrix",G.matrixWorld),z.uniformsGroups!==void 0){const ot=z.uniformsGroups;for(let yn=0,Qn=ot.length;yn<Qn;yn++){const Oa=ot[yn];$.update(Oa,zt),$.bind(Oa,zt)}}return zt}function Rl(x,U){x.ambientLightColor.needsUpdate=U,x.lightProbe.needsUpdate=U,x.directionalLights.needsUpdate=U,x.directionalLightShadows.needsUpdate=U,x.pointLights.needsUpdate=U,x.pointLightShadows.needsUpdate=U,x.spotLights.needsUpdate=U,x.spotLightShadows.needsUpdate=U,x.rectAreaLights.needsUpdate=U,x.hemisphereLights.needsUpdate=U}function Cl(x){return x.isMeshLambertMaterial||x.isMeshToonMaterial||x.isMeshPhongMaterial||x.isMeshStandardMaterial||x.isShadowMaterial||x.isShaderMaterial&&x.lights===!0}this.getActiveCubeFace=function(){return W},this.getActiveMipmapLevel=function(){return Y},this.getRenderTarget=function(){return N},this.setRenderTargetTextures=function(x,U,H){const z=M.get(x);z.__autoAllocateDepthBuffer=x.resolveDepthBuffer===!1,z.__autoAllocateDepthBuffer===!1&&(z.__useRenderToTexture=!1),M.get(x.texture).__webglTexture=U,M.get(x.depthTexture).__webglTexture=z.__autoAllocateDepthBuffer?void 0:H,z.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(x,U){const H=M.get(x);H.__webglFramebuffer=U,H.__useDefaultFramebuffer=U===void 0};const Pl=C.createFramebuffer();this.setRenderTarget=function(x,U=0,H=0){N=x,W=U,Y=H;let z=null,G=!1,me=!1;if(x){const pe=M.get(x);if(pe.__useDefaultFramebuffer!==void 0){ue.bindFramebuffer(C.FRAMEBUFFER,pe.__webglFramebuffer),J.copy(x.viewport),ne.copy(x.scissor),oe=x.scissorTest,ue.viewport(J),ue.scissor(ne),ue.setScissorTest(oe),B=-1;return}else if(pe.__webglFramebuffer===void 0)d.setupRenderTarget(x);else if(pe.__hasExternalTextures)d.rebindTextures(x,M.get(x.texture).__webglTexture,M.get(x.depthTexture).__webglTexture);else if(x.depthBuffer){const ze=x.depthTexture;if(pe.__boundDepthTexture!==ze){if(ze!==null&&M.has(ze)&&(x.width!==ze.image.width||x.height!==ze.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");d.setupDepthRenderbuffer(x)}}const be=x.texture;(be.isData3DTexture||be.isDataArrayTexture||be.isCompressedArrayTexture)&&(me=!0);const Re=M.get(x).__webglFramebuffer;x.isWebGLCubeRenderTarget?(Array.isArray(Re[U])?z=Re[U][H]:z=Re[U],G=!0):x.samples>0&&d.useMultisampledRTT(x)===!1?z=M.get(x).__webglMultisampledFramebuffer:Array.isArray(Re)?z=Re[H]:z=Re,J.copy(x.viewport),ne.copy(x.scissor),oe=x.scissorTest}else J.copy(ie).multiplyScalar(Le).floor(),ne.copy(ye).multiplyScalar(Le).floor(),oe=De;if(H!==0&&(z=Pl),ue.bindFramebuffer(C.FRAMEBUFFER,z)&&ue.drawBuffers(x,z),ue.viewport(J),ue.scissor(ne),ue.setScissorTest(oe),G){const pe=M.get(x.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_CUBE_MAP_POSITIVE_X+U,pe.__webglTexture,H)}else if(me){const pe=U;for(let be=0;be<x.textures.length;be++){const Re=M.get(x.textures[be]);C.framebufferTextureLayer(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0+be,Re.__webglTexture,H,pe)}}else if(x!==null&&H!==0){const pe=M.get(x.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,pe.__webglTexture,H)}B=-1},this.readRenderTargetPixels=function(x,U,H,z,G,me,Se,pe=0){if(!(x&&x.isWebGLRenderTarget)){$e("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let be=M.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&Se!==void 0&&(be=be[Se]),be){ue.bindFramebuffer(C.FRAMEBUFFER,be);try{const Re=x.textures[pe],ze=Re.format,We=Re.type;if(x.textures.length>1&&C.readBuffer(C.COLOR_ATTACHMENT0+pe),!Ye.textureFormatReadable(ze)){$e("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Ye.textureTypeReadable(We)){$e("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}U>=0&&U<=x.width-z&&H>=0&&H<=x.height-G&&C.readPixels(U,H,z,G,P.convert(ze),P.convert(We),me)}finally{const Re=N!==null?M.get(N).__webglFramebuffer:null;ue.bindFramebuffer(C.FRAMEBUFFER,Re)}}},this.readRenderTargetPixelsAsync=async function(x,U,H,z,G,me,Se,pe=0){if(!(x&&x.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let be=M.get(x).__webglFramebuffer;if(x.isWebGLCubeRenderTarget&&Se!==void 0&&(be=be[Se]),be)if(U>=0&&U<=x.width-z&&H>=0&&H<=x.height-G){ue.bindFramebuffer(C.FRAMEBUFFER,be);const Re=x.textures[pe],ze=Re.format,We=Re.type;if(x.textures.length>1&&C.readBuffer(C.COLOR_ATTACHMENT0+pe),!Ye.textureFormatReadable(ze))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Ye.textureTypeReadable(We))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Ce=C.createBuffer();C.bindBuffer(C.PIXEL_PACK_BUFFER,Ce),C.bufferData(C.PIXEL_PACK_BUFFER,me.byteLength,C.STREAM_READ),C.readPixels(U,H,z,G,P.convert(ze),P.convert(We),0);const nt=N!==null?M.get(N).__webglFramebuffer:null;ue.bindFramebuffer(C.FRAMEBUFFER,nt);const dt=C.fenceSync(C.SYNC_GPU_COMMANDS_COMPLETE,0);return C.flush(),await Mc(C,dt,4),C.bindBuffer(C.PIXEL_PACK_BUFFER,Ce),C.getBufferSubData(C.PIXEL_PACK_BUFFER,0,me),C.deleteBuffer(Ce),C.deleteSync(dt),me}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(x,U=null,H=0){const z=Math.pow(2,-H),G=Math.floor(x.image.width*z),me=Math.floor(x.image.height*z),Se=U!==null?U.x:0,pe=U!==null?U.y:0;d.setTexture2D(x,0),C.copyTexSubImage2D(C.TEXTURE_2D,H,0,0,Se,pe,G,me),ue.unbindTexture()};const Dl=C.createFramebuffer(),Ll=C.createFramebuffer();this.copyTextureToTexture=function(x,U,H=null,z=null,G=0,me=0){let Se,pe,be,Re,ze,We,Ce,nt,dt;const ct=x.isCompressedTexture?x.mipmaps[me]:x.image;if(H!==null)Se=H.max.x-H.min.x,pe=H.max.y-H.min.y,be=H.isBox3?H.max.z-H.min.z:1,Re=H.min.x,ze=H.min.y,We=H.isBox3?H.min.z:0;else{const pt=Math.pow(2,-G);Se=Math.floor(ct.width*pt),pe=Math.floor(ct.height*pt),x.isDataArrayTexture?be=ct.depth:x.isData3DTexture?be=Math.floor(ct.depth*pt):be=1,Re=0,ze=0,We=0}z!==null?(Ce=z.x,nt=z.y,dt=z.z):(Ce=0,nt=0,dt=0);const st=P.convert(U.format),yt=P.convert(U.type);let Me;U.isData3DTexture?(d.setTexture3D(U,0),Me=C.TEXTURE_3D):U.isDataArrayTexture||U.isCompressedArrayTexture?(d.setTexture2DArray(U,0),Me=C.TEXTURE_2D_ARRAY):(d.setTexture2D(U,0),Me=C.TEXTURE_2D),ue.activeTexture(C.TEXTURE0),ue.pixelStorei(C.UNPACK_FLIP_Y_WEBGL,U.flipY),ue.pixelStorei(C.UNPACK_PREMULTIPLY_ALPHA_WEBGL,U.premultiplyAlpha),ue.pixelStorei(C.UNPACK_ALIGNMENT,U.unpackAlignment);const It=ue.getParameter(C.UNPACK_ROW_LENGTH),Ke=ue.getParameter(C.UNPACK_IMAGE_HEIGHT),zt=ue.getParameter(C.UNPACK_SKIP_PIXELS),$t=ue.getParameter(C.UNPACK_SKIP_ROWS),Sn=ue.getParameter(C.UNPACK_SKIP_IMAGES);ue.pixelStorei(C.UNPACK_ROW_LENGTH,ct.width),ue.pixelStorei(C.UNPACK_IMAGE_HEIGHT,ct.height),ue.pixelStorei(C.UNPACK_SKIP_PIXELS,Re),ue.pixelStorei(C.UNPACK_SKIP_ROWS,ze),ue.pixelStorei(C.UNPACK_SKIP_IMAGES,We);const Jn=x.isDataArrayTexture||x.isData3DTexture,at=U.isDataArrayTexture||U.isData3DTexture;if(x.isDepthTexture){const pt=M.get(x),En=M.get(U),ot=M.get(pt.__renderTarget),yn=M.get(En.__renderTarget);ue.bindFramebuffer(C.READ_FRAMEBUFFER,ot.__webglFramebuffer),ue.bindFramebuffer(C.DRAW_FRAMEBUFFER,yn.__webglFramebuffer);for(let Qn=0;Qn<be;Qn++)Jn&&(C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,M.get(x).__webglTexture,G,We+Qn),C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,M.get(U).__webglTexture,me,dt+Qn)),C.blitFramebuffer(Re,ze,Se,pe,Ce,nt,Se,pe,C.DEPTH_BUFFER_BIT,C.NEAREST);ue.bindFramebuffer(C.READ_FRAMEBUFFER,null),ue.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else if(G!==0||x.isRenderTargetTexture||M.has(x)){const pt=M.get(x),En=M.get(U);ue.bindFramebuffer(C.READ_FRAMEBUFFER,Dl),ue.bindFramebuffer(C.DRAW_FRAMEBUFFER,Ll);for(let ot=0;ot<be;ot++)Jn?C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,pt.__webglTexture,G,We+ot):C.framebufferTexture2D(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,pt.__webglTexture,G),at?C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,En.__webglTexture,me,dt+ot):C.framebufferTexture2D(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,En.__webglTexture,me),G!==0?C.blitFramebuffer(Re,ze,Se,pe,Ce,nt,Se,pe,C.COLOR_BUFFER_BIT,C.NEAREST):at?C.copyTexSubImage3D(Me,me,Ce,nt,dt+ot,Re,ze,Se,pe):C.copyTexSubImage2D(Me,me,Ce,nt,Re,ze,Se,pe);ue.bindFramebuffer(C.READ_FRAMEBUFFER,null),ue.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else at?x.isDataTexture||x.isData3DTexture?C.texSubImage3D(Me,me,Ce,nt,dt,Se,pe,be,st,yt,ct.data):U.isCompressedArrayTexture?C.compressedTexSubImage3D(Me,me,Ce,nt,dt,Se,pe,be,st,ct.data):C.texSubImage3D(Me,me,Ce,nt,dt,Se,pe,be,st,yt,ct):x.isDataTexture?C.texSubImage2D(C.TEXTURE_2D,me,Ce,nt,Se,pe,st,yt,ct.data):x.isCompressedTexture?C.compressedTexSubImage2D(C.TEXTURE_2D,me,Ce,nt,ct.width,ct.height,st,ct.data):C.texSubImage2D(C.TEXTURE_2D,me,Ce,nt,Se,pe,st,yt,ct);ue.pixelStorei(C.UNPACK_ROW_LENGTH,It),ue.pixelStorei(C.UNPACK_IMAGE_HEIGHT,Ke),ue.pixelStorei(C.UNPACK_SKIP_PIXELS,zt),ue.pixelStorei(C.UNPACK_SKIP_ROWS,$t),ue.pixelStorei(C.UNPACK_SKIP_IMAGES,Sn),me===0&&U.generateMipmaps&&C.generateMipmap(Me),ue.unbindTexture()},this.initRenderTarget=function(x){M.get(x).__webglFramebuffer===void 0&&d.setupRenderTarget(x)},this.initTexture=function(x){x.isCubeTexture?d.setTextureCube(x,0):x.isData3DTexture?d.setTexture3D(x,0):x.isDataArrayTexture||x.isCompressedArrayTexture?d.setTexture2DArray(x,0):d.setTexture2D(x,0),ue.unbindTexture()},this.resetState=function(){W=0,Y=0,N=null,ue.reset(),ae.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Qt}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=Xe._getDrawingBufferColorSpace(e),t.unpackColorSpace=Xe._getUnpackColorSpace()}}const Lt={head_lr:[1828,2298],head_ud:[2885,3278],eye:[1960,2130],jaw:[1534,1728],brow:[2051,2099]},bl=(i,[e,t])=>Math.max(0,Math.min(1,(i-e)/(t-e))),dr=(i,e)=>bl(i,e)*2-1,pr={happy:{skin:16115404,cheek:15906985,mouth:12674132,eyeShine:16774102},sad:{skin:15130312,cheek:11056852,mouth:8414842,eyeShine:13030123},angry:{skin:15914168,cheek:14708833,mouth:11877678,eyeShine:16769984},surprised:{skin:16115404,cheek:15710375,mouth:10242654,eyeShine:16770800},neutral:{skin:15786694,cheek:14989470,mouth:10053722,eyeShine:16773334},agree:{skin:15721933,cheek:11978650,mouth:8030816,eyeShine:15068374},disagree:{skin:15915190,cheek:14390896,mouth:11033136,eyeShine:16767403}},Di=(i,e,t)=>{const n=new Ze(i),r=new Ze(e);return n.lerp(r,t).getHex()};function im(i){const e=i.clientWidth,t=i.clientHeight,n=new Fc;n.background=null;const r=new Vt(34,e/t,.1,100);r.position.set(0,.15,5.4),r.lookAt(0,0,0);const s=new nm({antialias:!0,alpha:!0});s.setPixelRatio(Math.min(2,window.devicePixelRatio)),s.setSize(e,t,!1),s.outputColorSpace=Ft,s.toneMapping=ua,s.toneMappingExposure=1.05,i.appendChild(s.domElement);const a=new nu(16773334,.45);n.add(a);const o=new cs(16766627,1.6);o.position.set(2.4,3.2,3.2),n.add(o);const c=new cs(9083844,.55);c.position.set(-3.4,.4,1.8),n.add(c);const l=new cs(15710375,.7);l.position.set(.8,1.6,-3.6),n.add(l);const f=new mn;n.add(f);const m=new Hn({color:15786694,roughness:.88,metalness:0,flatShading:!1}),u=new dn(1.2,96,96),_=u.attributes.position,v=new O;for(let Pe=0;Pe<_.count;Pe++)v.fromBufferAttribute(_,Pe),v.y*=1.12,v.z*=1.04,v.y<0&&(v.x*=1+v.y*.05),_.setXYZ(Pe,v.x,v.y,v.z);u.computeVertexNormals();const y=new lt(u,m);f.add(y);const p=Pe=>{const M=new Ui(.21,1.05,12,24),d=m.clone(),I=new lt(M,d);return I.position.set(Pe*.62,1.55,-.05),I.rotation.set(.18,0,Pe*-.16),I.userData.restRot=I.rotation.clone(),f.add(I),I},h=p(-1),S=p(1),T=new Hn({color:1183762,roughness:.18,metalness:.05}),E=new Ar({color:16773334}),R=Pe=>{const M=new mn,d=new lt(new dn(.27,32,32),new Hn({color:14009507,roughness:1,side:Ct}));d.scale.set(1,1,.6),M.add(d);const I=new lt(new dn(.22,48,48),T);M.add(I);const q=new lt(new dn(.05,16,16),E);q.position.set(-.07,.09,.18),M.add(q);const Z=new lt(new dn(.025,12,12),E);return Z.position.set(.04,-.04,.2),M.add(Z),M.position.set(Pe,.12,1.05),M.userData.restPos=M.position.clone(),f.add(M),M},b=R(-.4),D=R(.4),g=new mn,A=new lt(new ya(.55,.06,12,32,Math.PI*.55),new Hn({color:9071178,roughness:.85}));A.rotation.z=Math.PI,A.position.set(0,.55,1),g.add(A),g.userData.restY=g.position.y,f.add(g);const L=new mn,w=new Hn({color:10053722,roughness:.6}),F=new lt(new Ni(.32,32,0,Math.PI),w);F.rotation.x=Math.PI,F.position.set(0,-.16,0),L.add(F);const W=new lt(new Ni(.18,24,0,Math.PI),new Hn({color:12024171,roughness:.7}));W.rotation.x=Math.PI,W.position.set(0,-.18,.01),L.add(W),L.position.set(0,-.4,1.07),f.add(L);const Y=new Hn({color:15710375,roughness:.92,transparent:!0,opacity:.7}),N=new Ni(.18,24),B=new lt(N,Y);B.position.set(-.62,-.18,1.03),f.add(B);const V=new lt(N,Y.clone());V.position.set(.62,-.18,1.03),f.add(V);const J=new mn,ne=new Ar({visible:!1}),oe=new lt(new dn(.9,16,16),ne);oe.position.set(0,.9,0),oe.userData.zone="head",J.add(oe);const ve=new lt(new Ui(.35,1.1,8,12),ne);ve.position.copy(h.position),ve.rotation.copy(h.rotation),ve.userData.zone="earL",J.add(ve);const Ee=new lt(new Ui(.35,1.1,8,12),ne);Ee.position.copy(S.position),Ee.rotation.copy(S.rotation),Ee.userData.zone="earR",J.add(Ee);const ke=new lt(new dn(.42,16,16),ne);ke.position.set(0,-.5,1.05),ke.userData.zone="mouth",J.add(ke),f.add(J);const Ve={head_lr:(Lt.head_lr[0]+Lt.head_lr[1])/2,head_ud:(Lt.head_ud[0]+Lt.head_ud[1])/2,eye:(Lt.eye[0]+Lt.eye[1])/2,jaw:Lt.jaw[0],brow:(Lt.brow[0]+Lt.brow[1])/2},Le={...Ve},K=Pe=>{for(const M of Object.keys(Pe))typeof Pe[M]=="number"&&(Le[M]=Pe[M])};let le=pr.neutral,ie=1,ye=pr.neutral;const De=(Pe,M=.6)=>{const d=pr[Pe]??pr.neutral;d!==le&&(ye={skin:m.color.getHex(),cheek:B.material.color.getHex(),mouth:w.color.getHex(),eyeShine:E.color.getHex()},le=d,ie=0)};let we=0;const it=()=>{we=1},j={L:0,R:0},ge=Pe=>{j[Pe]=1};let fe=0;const Te=()=>{fe=1};let Fe=0,Qe=3+Math.random()*4,vt=performance.now(),C;const rt=Pe=>{const M=Math.min(.05,(Pe-vt)/1e3);vt=Pe;const d=1-Math.exp(-M*7);for(const ee of Object.keys(Ve))Ve[ee]+=(Le[ee]-Ve[ee])*d;f.rotation.y=dr(Ve.head_lr,Lt.head_lr)*.45,f.rotation.x=dr(Ve.head_ud,Lt.head_ud)*.32*-1;const I=dr(Ve.eye,Lt.eye)*.06;b.position.x=b.userData.restPos.x+I,D.position.x=D.userData.restPos.x+I,L.rotation.x=bl(Ve.jaw,Lt.jaw)*.55,g.position.y=g.userData.restY+dr(Ve.brow,Lt.brow)*.05,Qe-=M,Qe<=0&&Fe===0&&(Fe=1),Fe>0&&(Fe-=M*7,Fe<=0&&(Fe=0,Qe=3+Math.random()*4));const q=Fe>0?Math.max(.05,1-Fe):1;if(b.scale.y=q,D.scale.y=q,we>0){we-=M*3;const ee=Math.max(0,we);f.scale.y=1-.08*Math.sin(ee*Math.PI),f.scale.x=1+.05*Math.sin(ee*Math.PI),we<=0&&f.scale.set(1,1,1)}for(const ee of["L","R"])if(j[ee]>0){j[ee]-=M*2.4;const Q=ee==="L"?h:S,k=Q.userData.restRot,X=(1-j[ee])*Math.PI*4;Q.rotation.x=k.x+Math.sin(X)*.22*j[ee],Q.rotation.z=k.z+Math.cos(X)*.16*j[ee],j[ee]<=0&&Q.rotation.copy(k)}const Z=Math.sin(Pe*.0014)*.025;if(f.position.y=Z,fe>0){fe-=M*2.5;const ee=1+Math.max(0,fe)*.06;f.scale.setScalar(ee)}ie<1&&(ie=Math.min(1,ie+M*1.4),m.color.setHex(Di(ye.skin,le.skin,ie)),B.material.color.setHex(Di(ye.cheek,le.cheek,ie)),V.material.color.setHex(Di(ye.cheek,le.cheek,ie)),w.color.setHex(Di(ye.mouth,le.mouth,ie)),E.color.setHex(Di(ye.eyeShine,le.eyeShine,ie))),s.render(n,r),C=requestAnimationFrame(rt)};C=requestAnimationFrame(rt);const Oe=()=>{const Pe=i.clientWidth,M=i.clientHeight;Pe===0||M===0||(r.aspect=Pe/M,r.updateProjectionMatrix(),s.setSize(Pe,M,!1))},Ye=new ResizeObserver(Oe);return Ye.observe(i),{scene:n,camera:r,renderer:s,head:f,leftEar:h,rightEar:S,leftEye:b,rightEye:D,jaw:L,brow:g,cheekL:B,cheekR:V,ambient:a,key:o,fill:c,rim:l,hitGroup:J,setPose:K,setEmotion:De,bumpScale:Te,squashOnPat:it,wobbleEar:ge,dispose:()=>{C&&cancelAnimationFrame(C),Ye.disconnect(),s.dispose(),i.removeChild(s.domElement),n.traverse(Pe=>{const M=Pe.material,d=Pe.geometry;d&&d.dispose(),Array.isArray(M)?M.forEach(I=>I.dispose()):M&&M.dispose()})}}}var rm=Zn('<div style="position:absolute;transform:translate(-50%, -100%);padding:8px 14px;border-radius:999px;background:rgba(243, 236, 220, 0.95);color:#1a1410;font-family:var(--f-display);font-style:italic;font-size:16px;box-shadow:0 8px 24px rgba(0,0,0,.4);z-index:5;pointer-events:none;animation:fade-up .4s cubic-bezier(.2,.7,.3,1.1) both;white-space:nowrap">'),sm=Zn('<div style="max-width:560px;margin:0 auto 14px;padding:10px 16px;border-radius:16px;background:rgba(243, 236, 220, 0.07);backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px);border:1px solid rgba(243, 236, 220, .08);color:var(--c-bone);font-family:var(--f-display);font-style:italic;font-size:16px;line-height:1.35;text-align:center;pointer-events:auto;animation:fade-up .4s cubic-bezier(.2,.7,.3,1.1) both">'),am=Zn('<div style="color:var(--c-stone);font-size:13px;text-align:center;padding:20px 8px;font-family:var(--f-display);font-style:italic">say hi to lafufu...'),om=Zn('<div style="max-width:560px;margin:0 auto 12px;background:rgba(15, 11, 8, 0.85);backdrop-filter:blur(14px);-webkit-backdrop-filter:blur(14px);border-radius:20px;border:1px solid rgba(243, 236, 220, .1);padding:14px;max-height:44vh;display:flex;flex-direction:column;pointer-events:auto"><div class=scroll-warm style=flex:1;overflow-y:auto;padding-right:6px;margin-bottom:8px;display:flex;flex-direction:column;gap:8px></div><div style=display:flex;gap:8px><input class=field placeholder="type to lafufu..."style=flex:1><button class="btn btn--primary">send'),lm=Zn('<div style="position:fixed;inset:0;background:radial-gradient(circle at 50% 30%, #2d2018 0%, #1a1410 60%, #0c0907 100%);overflow:hidden;touch-action:none"><div style="position:absolute;top:max(14px, env(safe-area-inset-top));left:16px;right:16px;display:flex;justify-content:space-between;align-items:center;z-index:3"><div class=eyebrow></div><div style=display:flex;gap:8px;align-items:center;font-family:var(--f-mono);font-size:11px;color:var(--c-mist)><span>/</span><span style=opacity:0.4>·</span><a href=/admin style=color:var(--c-mist);text-decoration:none;opacity:0.7>admin →</a></div></div><div style=position:absolute;inset:0;z-index:2></div><div style="position:absolute;bottom:0;left:0;right:0;padding:20px 16px max(20px, env(safe-area-inset-bottom)) 16px;z-index:3;background:linear-gradient(to top, rgba(12,9,7,0.85) 0%, rgba(12,9,7,0) 100%);pointer-events:none"><div style=display:flex;justify-content:center;gap:10px;flex-wrap:wrap;pointer-events:auto><button></button><button class="btn btn--tiny">enable shake</button><button class="btn btn--tiny">hint'),cm=Zn("<span class=f-mono style=font-size:10px;margin-right:6px;opacity:0.85> "),um=Zn('<div style="max-width:82%;padding:8px 12px;color:var(--c-bone);font-size:14px;line-height:1.35;border:1px solid var(--c-edge)">');const pm=()=>{const[i,e]=on("idle"),[t,n]=on("neutral"),[r,s]=on(),[a,o]=on(null),[c,l]=on([]),[f,m]=on(!1),[u,_]=on(""),[v,y]=on(!1),[p,h]=on(new Set),S=new zl;let T,E;const R=[{id:"pat",label:"Pat the head"},{id:"tugL",label:"Tug an ear"},{id:"tugR",label:"Tug the other ear"},{id:"poke",label:"Poke the mouth"},{id:"shake",label:"Shake the device"},{id:"spin",label:"Spin it around"}],b=(j,ge,fe)=>{const Te=Date.now();o({x:j,y:ge,text:fe,id:Te}),window.setTimeout(()=>o(Fe=>(Fe==null?void 0:Fe.id)===Te?null:Fe),1600)},D=j=>{h(ge=>{if(ge.has(j))return ge;const fe=new Set(ge);return fe.add(j),On.ok(`easter egg unlocked: ${j}`,`${fe.size} / ${R.length} found`),fe})},g=async j=>{try{await Va.animatorExpression(j),n(j),E==null||E.setEmotion(j)}catch{E==null||E.setEmotion(j),n(j)}};let A=!1,L=!1,w=0,F=0,W=0,Y=0,N=0,B=0,V=0,J=0;const ne=new su,oe=new je,ve=(j,ge)=>{const fe=T.getBoundingClientRect();oe.x=(j-fe.left)/fe.width*2-1,oe.y=-((ge-fe.top)/fe.height)*2+1,E&&ne.setFromCamera(oe,E.camera)},Ee=(j,ge)=>{if(!E)return null;ve(j,ge);const fe=ne.intersectObjects(E.hitGroup.children,!1);return fe.length?fe[0].object.userData.zone:null},ke=j=>{A=!0,L=!1,w=j.clientX,F=j.clientY,W=j.clientX,Y=j.clientY,N=performance.now(),j.target.setPointerCapture(j.pointerId)},Ve=j=>{if(!A)return;const ge=j.clientX-w,fe=j.clientY-F;Math.hypot(j.clientX-W,j.clientY-Y)>5&&(L=!0),w=j.clientX,F=j.clientY,B+=ge*.006,V+=fe*.006,J=fe,V=Math.max(-.7,Math.min(.7,V))},Le=j=>{if(!A)return;A=!1;const ge=performance.now()-N;if(!L&&ge<350){const fe=Ee(j.clientX,j.clientY);fe&&le(fe,j.clientX,j.clientY)}else{const fe=Ee(W,Y);fe==="earL"&&J>6&&(D("tugL"),E==null||E.wobbleEar("L"),g("surprised"),b(j.clientX,j.clientY,"boi-oing!")),fe==="earR"&&J>6&&(D("tugR"),E==null||E.wobbleEar("R"),g("surprised"),b(j.clientX,j.clientY,"boi-oing!")),Math.abs(B)>Math.PI*1.4&&(D("spin"),g("disagree"),b(j.clientX,j.clientY,"stop spinning me!"),B=B%(Math.PI*2))}};let K=[];const le=(j,ge,fe)=>{if(E==null||E.bumpScale(),j==="head"){const Te=performance.now();K=K.filter(Fe=>Te-Fe<1200),K.push(Te),K.length>=3?(K=[],D("pat"),E==null||E.squashOnPat(),g("happy"),b(ge,fe,"yay! :)")):b(ge,fe,"more!")}(j==="earL"||j==="earR")&&(E==null||E.wobbleEar(j==="earL"?"L":"R"),b(ge,fe,"tickles")),j==="mouth"&&(D("poke"),g("disagree"),b(ge,fe,"hey!"))};let ie=0,ye=0;const De=j=>{const ge=j.accelerationIncludingGravity;if(!ge)return;const fe=Math.hypot(ge.x??0,ge.y??0,ge.z??0),Te=Math.abs(fe-ie);ie=fe,ye=ye*.92+Te,ye>35&&(ye=0,D("shake"),g("angry"),b(window.innerWidth/2,80,"stop shaking!"))};Il(()=>{E=im(T),S.start(),S.subscribe("agent.state.*",fe=>{const Te=fe.topic.split(".").pop();Te&&e(Te)}),S.subscribe("agent.reply",fe=>{const Te=fe.payload.emotion??"neutral";n(Te),E==null||E.setEmotion(Te),s(fe.payload.text),l(Fe=>[...Fe.slice(-30),{who:"lafufu",text:fe.payload.text,emotion:Te,ts:Date.now()}])}),S.subscribe("agent.transcript",fe=>{s(fe.payload.text),l(Te=>[...Te.slice(-30),{who:"you",text:fe.payload.text,ts:Date.now()}])}),S.subscribe("animator.pose",fe=>{E==null||E.setPose(fe.payload)});let j;const ge=()=>{E&&(B*=.985,V*=.985,E.head.rotation.y+=B*.04,E.head.rotation.x+=V*.04),j=requestAnimationFrame(ge)};j=requestAnimationFrame(ge),window.addEventListener("devicemotion",De,{passive:!0}),Ba(()=>{j&&cancelAnimationFrame(j),window.removeEventListener("devicemotion",De)})}),Ba(()=>{E==null||E.dispose(),S.stop()});const we=async()=>{const j=u().trim();if(!(!j||v())){y(!0),_(""),l(ge=>[...ge.slice(-30),{who:"you",text:j,ts:Date.now()}]);try{await Va.agentTextMessage(j)}catch(ge){On.err("couldn't reach lafufu",ge.message)}finally{y(!1)}}},it=async()=>{const j=window.DeviceMotionEvent;if(j&&typeof j.requestPermission=="function")try{await j.requestPermission()==="granted"?On.ok("motion enabled","now try shaking 🪄"):On.warn("motion denied")}catch(ge){On.err("motion error",ge.message)}else On.info("motion already active on this device")};return(()=>{var j=lm(),ge=j.firstChild,fe=ge.firstChild,Te=fe.nextSibling,Fe=Te.firstChild,Qe=Fe.firstChild,vt=Fe.nextSibling;vt.nextSibling;var C=ge.nextSibling,rt=C.nextSibling,Oe=rt.firstChild,Ye=Oe.firstChild,ue=Ye.nextSibling,Pe=ue.nextSibling;St(j,bn(za,{size:"55vmin",get color(){return Ur(t())},opacity:.32,blur:70,style:{top:"-12vmin",left:"-12vmin"},drift:!0,delay:0}),ge),St(j,bn(za,{size:"40vmin",color:"var(--c-mauve)",opacity:.18,blur:60,variant:2,style:{bottom:"-10vmin",right:"-10vmin"},drift:!0,delay:6}),ge),St(fe,i),St(Fe,()=>p().size,Qe),St(Fe,()=>R.length,null),C.addEventListener("pointercancel",Le),C.$$pointerup=Le,C.$$pointermove=Ve,C.$$pointerdown=ke;var M=T;return typeof M=="function"?Ol(M,C):T=C,St(j,bn(yi,{get when(){return a()},get children(){var d=rm();return St(d,()=>a().text),ei(I=>{var q=`${a().x}px`,Z=`${a().y-60}px`;return q!==I.e&&Fn(d,"left",I.e=q),Z!==I.t&&Fn(d,"top",I.t=Z),I},{e:void 0,t:void 0}),d}}),rt),St(rt,bn(yi,{get when(){return Ga(()=>!!r())()&&!f()},get children(){var d=sm();return St(d,r),d}}),Oe),St(rt,bn(yi,{get when(){return f()},get children(){var d=om(),I=d.firstChild,q=I.nextSibling,Z=q.firstChild,ee=Z.nextSibling;return St(I,bn(Ul,{get each(){return c()},children:Q=>(()=>{var k=um();return St(k,bn(yi,{get when(){return Ga(()=>Q.who==="lafufu")()&&Q.emotion},get children(){var X=cm(),he=X.firstChild;return St(X,()=>Nl[Q.emotion??"neutral"],he),St(X,()=>Q.emotion,null),ei(_e=>Fn(X,"color",Ur(Q.emotion))),X}}),null),St(k,()=>Q.text,null),ei(X=>{var he=Q.who==="you"?"flex-end":"flex-start",_e=Q.who==="you"?"16px 16px 4px 16px":"16px 16px 16px 4px",re=Q.who==="you"?"var(--c-raised)":"rgba(149,176,122,0.15)";return he!==X.e&&Fn(k,"align-self",X.e=he),_e!==X.t&&Fn(k,"border-radius",X.t=_e),re!==X.a&&Fn(k,"background",X.a=re),X},{e:void 0,t:void 0,a:void 0}),k})()}),null),St(I,bn(yi,{get when(){return c().length===0},get children(){return am()}}),null),Z.$$keydown=Q=>Q.key==="Enter"&&we(),Z.$$input=Q=>_(Q.currentTarget.value),ee.$$click=we,ei(Q=>{var k=v(),X=v();return k!==Q.e&&(Z.disabled=Q.e=k),X!==Q.t&&(ee.disabled=Q.t=X),Q},{e:void 0,t:void 0}),ei(()=>Z.value=u()),d}}),Oe),Ye.$$click=()=>m(d=>!d),St(Ye,()=>f()?"hide chat":"open chat"),ue.$$click=it,Pe.$$click=()=>{const d=p(),q=R.filter(Z=>!d.has(Z.id))[0]??R[0];On.info(`hint: ${q.label}`,`${d.size}/${R.length} unlocked`)},ei(d=>{var I=Ur(t()),q=`btn btn--tiny ${f()?"btn--primary":""}`;return I!==d.e&&Fn(fe,"color",d.e=I),q!==d.t&&Fl(Ye,d.t=q),d},{e:void 0,t:void 0}),j})()};Bl(["pointerdown","pointermove","pointerup","input","keydown","click"]);export{pm as default};
